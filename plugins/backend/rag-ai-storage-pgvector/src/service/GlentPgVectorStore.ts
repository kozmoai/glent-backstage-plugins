...
export interface GlentPgVectorStoreConfig {
  logger: Logger;
  db: Knex;
  /**
 ...
 */
export class GlentPgVectorStore implements GlentVectorStore {
  ...
  /**
   * Initializes the GlentPgVectorStore.
   *
   * @param {GlentPgVectorStoreConfig} config - The configuration for GlentPgVectorStore.
   *
   * @return {Promise<GlentPgVectorStore>} A Promise that resolves to an instance of GlentPgVectorStore.
   */
  static async initialize(
    config: GlentPgVectorStoreConfig,
  ): Promise<GlentPgVectorStore> {
    return new GlentPgVectorStore(config);
  }

  /**
   * Constructor for GlentPgVectorStore class.
   *
   * @param {GlentPgVectorStoreConfig} config - The configuration object for GlentPgVectorStore.
   ...
   */
  private constructor(config: GlentPgVectorStoreConfig) {
   ...
   * @return {Promise<EmbeddingDoc[]>} - A promise that resolves to an array of GlentEmbeddingDoc objects representing the search results.
