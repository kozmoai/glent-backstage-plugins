...
export const groupEntityMock = {
  ...
  spec: {
    type: 'team',
    profile: {
      displayName: 'glent-backstage-admin',
      email: 'rglent-backstage-admin@example.com',
      picture:
...
export const groupEntityMockWithSlug = {
  metadata: {
    ...
    annotations: {
      'backstage.io/managed-by-location':
        'url:https://raw.githubusercontent.com/RoadieHQ/sample-service/main/admin-group.yaml',
      'github.com/team-slug': 'rglent-backstage-admin',
    },
    name: 'glent-backstage-admin',
    description: 'The Backstage Admins',
    uid: '9a2bb4d3-db09-48c1-86fe-0b060e762484',
...
export const openPullsRequestMock = {
  ...
  items: [
    ...
    },
    {
      ...
      body: 'https://github.com/kozmoai/glent-backstage-plugins',
      reactions: {
...
export const closedPullsRequestMock = {
  ...
  items: [
    ...
    },
    {
      ...
      body: '<h3>Snyk has created this PR to upgrade @material-ui/core from 4.11.3 to 4.12.1.</h3>\n\n![merge advice](https://app.snyk.io/badges/merge-advice/?package_manager=yarn&package_name=@material-ui/core&from_version=4.11.3&to_version=4.12.1&pr_id=e03e6155-660a-454a-b976-e35a5162f1c2&visibility=true&has_feature_flag=false)\n:information_source: Keep your dependencies up-to-date. This makes it easier to fix existing vulnerabilities and to more quickly identify and fix newly disclosed vulnerabilities when they affect your project.\n<hr/>\n\n- The recommended version is **3 versions** ahead of your current version.\n- The recommended version was released **a month ago**, on 2021-07-07.\n\n\n<hr/>\n\n**Note:** *You are seeing this because you or someone else with access to this repository has authorized Snyk to open upgrade PRs.*\n\nFor more information:  <img src="https://api.segment.io/v1/pixel/track?data=eyJ3cml0ZUtleSI6InJyWmxZcEdHY2RyTHZsb0lYd0dUcVg4WkFRTnNCOUEwIiwiYW5vbnltb3VzSWQiOiJlMDNlNjE1NS02NjBhLTQ1NGEtYjk3Ni1lMzVhNTE2MmYxYzIiLCJldmVudCI6IlBSIHZpZXdlZCIsInByb3BlcnRpZXMiOnsicHJJZCI6ImUwM2U2MTU1LTY2MGEtNDU0YS1iOTc2LWUzNWE1MTYyZjFjMiJ9fQ==" width="0" height="0"/>\n\n🧐 [View latest project report](https://app.snyk.io/org/glent/project/5e6d83e1-ad28-4599-802e-aeb1f30950bc?utm_source&#x3D;github&amp;utm_medium&#x3D;upgrade-pr)\n\n🛠 [Adjust upgrade PR settings](https://app.snyk.io/org/glent/project/5e6d83e1-ad28-4599-802e-aeb1f30950bc/settings/integration?utm_source&#x3D;github&amp;utm_medium&#x3D;upgrade-pr)\n\n🔕 [Ignore this dependency or unsubscribe from future upgrade PRs](https://app.snyk.io/org/glent/project/5e6d83e1-ad28-4599-802e-aeb1f30950bc/settings/integration?pkg&#x3D;@material-ui/core&amp;utm_source&#x3D;github&amp;utm_medium&#x3D;upgrade-pr#auto-dep-upgrades)\n\n<!--- (snyk:metadata:{"prId":"e03e6155-660a-454a-b976-e35a5162f1c2","prPublicId":"e03e6155-660a-454a-b976-e35a5162f1c2","dependencies":[{"name":"@material-ui/core","from":"4.11.3","to":"4.12.1"}],"packageManager":"yarn","type":"auto","projectUrl":"https://app.snyk.io/org/glent/project/5e6d83e1-ad28-4599-802e-aeb1f30950bc?utm_source=github&utm_medium=upgrade-pr","projectPublicId":"5e6d83e1-ad28-4599-802e-aeb1f30950bc","env":"prod","prType":"upgrade","vulns":[],"issuesToFix":[],"upgrade":[],"upgradeInfo":{"versionsDiff":3,"publishedDate":"2021-07-07T13:06:32.449Z"},"templateVariants":["merge-advice-badge-shown"],"hasFixes":false,"isMajorUpgrade":false,"isBreakingChange":false,"priorityScoreList":[]}) --->\n',
      reactions: {
...
export const requestedReviewsMock = {
  ...
  items: [
    ...
    {
      url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462',
      repository_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins',
      labels_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462/labels{/name}',
      comments_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462/comments',
      events_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462/events',
      html_url: 'https://github.com/kozmoai/glent-backstage-plugins/pull/462',
      id: 1178106595,
      ...
      draft: false,
      pull_request: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/pulls/462',
        html_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/462',
        diff_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/462.diff',
        patch_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/462.patch',
        merged_at: null,
      },
      body: '<!-- Please describe what these changes achieve -->\r\n\r\n#### :heavy_check_mark: Checklist\r\n\r\n- [ ] Added tests for new functionality and regression tests for bug fixes\r\n- [ ] Screenshots of before and after attached (for UI changes)\r\n- [ ] Added or updated documentation (if applicable)\r\n',
      reactions: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462/reactions',
        total_count: 0,
        '+1': 0,
        '-1': 0,
        laugh: 0,
      ...
      timeline_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/462/timeline',
      performed_via_github_app: null,
      score: 1,
    },
  ],
...
export const repoMock = {
  ...
  name: 'glent-backstage-plugins',
  full_name: 'kozmoai/glent-backstage-plugins',
  private: false,
  owner: {
    login: 'kozmoai',
    id: 61759275,
  ...
  html_url: 'https://github.com/kozmoai/glent-backstage-plugins',
  description: 'All Backstage plugins created by Glent.',
  fork: false,
  url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins',
  forks_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/forks',
  keys_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/keys{/key_id}',
  collaborators_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/collaborators{/collaborator}',
  teams_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/teams',
  hooks_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/hooks',
  issue_events_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/events{/number}',
  events_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/events',
  assignees_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/assignees{/user}',
  branches_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/branches{/branch}',
  tags_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/tags',
  blobs_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/git/blobs{/sha}',
  git_tags_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/git/tags{/sha}',
  git_refs_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/git/refs{/sha}',
  trees_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/git/trees{/sha}',
  statuses_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/statuses/{sha}',
  languages_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/languages',
  stargazers_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/stargazers',
  contributors_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/contributors',
  subscribers_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/subscribers',
  subscription_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/subscription',
  commits_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/commits{/sha}',
  git_commits_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/git/commits{/sha}',
  comments_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/comments{/number}',
  issue_comment_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/comments{/number}',
  contents_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/contents/{+path}',
  compare_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/compare/{base}...{head}',
  merges_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/merges',
  archive_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/{archive_format}{/ref}',
  downloads_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/downloads',
  issues_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues{/number}',
  pulls_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/pulls{/number}',
  milestones_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/milestones{/number}',
  notifications_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/notifications{?since,all,participating}',
  labels_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/labels{/name}',
  releases_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/releases{/id}',
  deployments_url:
    'https://api.github.com/repos/kozmoai/glent-backstage-plugins/deployments',
  created_at: '2021-06-09T07:12:18Z',
  updated_at: '2022-03-28T10:58:52Z',
  pushed_at: '2022-03-28T08:46:06Z',
  git_url: 'git://github.com/kozmoai/glent-backstage-plugins.git',
  ssh_url: 'git@github.com:kozmoai/glent-backstage-plugins.git',
  clone_url: 'https://github.com/kozmoai/glent-backstage-plugins.git',
  svn_url: 'https://github.com/kozmoai/glent-backstage-plugins',
  homepage: 'https://glent.io',
  size: 18236,
  stargazers_count: 53,
  watchers_count: 53,
  language: 'TypeScript',
...
export const yourOpenPullRequests = {
  ...
  items: [
    {
      url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457',
      repository_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins',
      labels_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457/labels{/name}',
      comments_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457/comments',
      events_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457/events',
      html_url: 'https://github.com/kozmoai/glent-backstage-plugins/pull/457',
      id: 1175720871,
      ...
      draft: false,
      pull_request: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/pulls/457',
        html_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/457',
        diff_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/457.diff',
        patch_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/457.patch',
        merged_at: null,
      },
      body: '<!-- Please describe what these changes achieve -->\r\n\r\n![image](https://user-images.githubusercontent.com/24729496/160092420-aa408dce-445c-4f7b-96e2-8d4bae0944a1.png)\r\n\r\n\r\n\r\n#### :heavy_check_mark: Checklist\r\n\r\n- [ ] Added tests for new functionality and regression tests for bug fixes\r\n- [ ] Screenshots of before and after attached (for UI changes)\r\n- [ ] Added or updated documentation (if applicable)\r\n',
      reactions: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457/reactions',
        total_count: 0,
        '+1': 0,
        '-1': 0,
        laugh: 0,
      ...
      timeline_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/457/timeline',
      performed_via_github_app: null,
      score: 1,
    },
    {
      url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450',
      repository_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins',
      labels_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450/labels{/name}',
      comments_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450/comments',
      events_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450/events',
      html_url: 'https://github.com/kozmoai/glent-backstage-plugins/pull/450',
      id: 1166632752,
      ...
      draft: true,
      pull_request: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/pulls/450',
        html_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/450',
        diff_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/450.diff',
        patch_url:
          'https://github.com/kozmoai/glent-backstage-plugins/pull/450.patch',
        merged_at: null,
      },
      body: '<!-- Please describe what these changes achieve -->\r\nA POC to drive plugin behaviour based on UserEntity annotations.',
      reactions: {
        url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450/reactions',
        total_count: 0,
        '+1': 0,
        '-1': 0,
        laugh: 0,
      ...
      timeline_url:
        'https://api.github.com/repos/kozmoai/glent-backstage-plugins/issues/450/timeline',
      performed_via_github_app: null,
      score: 1,
    },
  ],
...
export const backstagePluginArgoCdMocks: Record<string, object> = {
  '85': {
    url: 'https://api.github.com/repos/kozmoai/glent-backstage-plugins/pulls/467',
    id: 894318735,
    number: 467,
    state: 'closed',
      ...
      requested_teams: [
        {
          ...
          html_url:
            'https://github.com/orgs/github/teams/rglent-backstage-admin',
          name: 'Glent Backstage Admins',
          slug: 'rglent-backstage-admin',
