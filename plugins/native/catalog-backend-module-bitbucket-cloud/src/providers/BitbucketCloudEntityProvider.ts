...
import { LocationEntity } from '@kozmoai/catalog-model';
...
import {
  ...
  Events,
  Models,
} from '@kozmoai/plugin-bitbucket-cloud-common';
import {
  DeferredEntity,
  EntityProvider,
...
export class BitbucketCloudEntityProvider implements EntityProvider {
  ...
  /** {@inheritdoc @kozmoai/plugin-catalog-backend#EntityProvider.getTaskId} */
  getTaskId(): string {
