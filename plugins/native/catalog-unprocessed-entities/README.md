...
Requires the `@kozmoai/plugin-catalog-backend-module-unprocessed` module to be installed.

## Installation

```shell
yarn --cwd packages/app add @kozmoai/plugin-catalog-unprocessed-entities
```

Import into your `App.tsx` and include into the `<FlatRoutes>` component:

```tsx title="packages/app/src/App.tsx"
import { CatalogUnprocessedEntitiesPage } from '@kozmoai/plugin-catalog-unprocessed-entities';
//...
...
```typescript
import { catalogUnprocessedEntitiesApiRef } from '@kozmoai/plugin-catalog-unprocessed-entities';
...
...
export { catalogUnprocessedEntitiesPlugin } from '@kozmoai/plugin-catalog-unprocessed-entities';
```
