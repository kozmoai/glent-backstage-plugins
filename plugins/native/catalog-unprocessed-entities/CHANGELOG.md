# @kozmoai/plugin-catalog-unprocessed-entities
...
- [#20998](https://github.com/kozmoai/glint/pull/20998) [`a11cdb9200`](https://github.com/kozmoai/glint/commit/a11cdb9200077312ca92ed85b159527226574c08) Thanks [@alde](https://github.com/alde)! - Added filtering and sorting to unprocessed entities tables.
...
- 57585d89f926: Export some types and API items. This allows people to call the API from different places with the ApiRef, as well
  as completely customize the client if required. Check the [README.md](https://github.com/kozmoai/glint/blob/master/plugins/catalog-unprocessed-entities/README.md) to
