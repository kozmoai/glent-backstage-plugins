...
import { createPlugin } from '@kozmoai/core-plugin-api';
import {
 ...
 * import { ExpandableNavigation } from '@kozmoai/plugin-techdocs-module-addons-contrib';
 *
 *
 * const AppRoutes = () => {
 *   <FlatRoutes>
 ...
 *
 * @remarks
 * Before using it, you should set up an `edit_uri` for your pages as explained {@link https://glint.io/docs/features/techdocs/faqs#is-it-possible-for-users-to-suggest-changes-or-provide-feedback-on-a-techdocs-page | here} and remember, it only works for Github or Gitlab.
 *
 * @example
 * Here's a simple example:
 * ```
