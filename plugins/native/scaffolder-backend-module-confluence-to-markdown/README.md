...
From your Glint root directory run:

```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-scaffolder-backend-module-confluence-to-markdown
```
...
import { createBuiltinActions } from '@kozmoai/plugin-scaffolder-backend';
import { ScmIntegrations } from '@kozmoai/integration';
import { createConfluenceToMarkdownAction } from '@kozmoai/plugin-scaffolder-backend-module-confluence-to-markdown';
...
You can find a list of all registered actions including their parameters at the `/create/actions` route in your Glint application.
