...
const KUBERNETES_ANNOTATION = 'glint.io/kubernetes-id';
const KUBERNETES_LABEL_SELECTOR_QUERY_ANNOTATION =
  'glint.io/kubernetes-label-selector';
  ...
  return (
    <>
      ...
      <Button
        variant="contained"
        color="primary"
        href="https://glint.io/docs/features/kubernetes/configuration#surfacing-your-kubernetes-components-as-part-of-an-entity"
      >
