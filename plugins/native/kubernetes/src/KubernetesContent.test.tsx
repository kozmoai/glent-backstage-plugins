...
import { useKubernetesObjects } from '@kozmoai/plugin-kubernetes-react';
...
jest.mock('@kozmoai/plugin-kubernetes-react', () => ({
  ...jest.requireActual('@kozmoai/plugin-kubernetes-react'),
