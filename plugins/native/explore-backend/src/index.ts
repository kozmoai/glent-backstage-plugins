...
/**
 * A Glint plugin for building an exploration page of your software ecosystem
 *
...
import { ToolDocumentCollatorFactory as _ToolDocumentCollatorFactory } from '@kozmoai/plugin-search-backend-module-explore';
import type {
  ToolDocument as _ToolDocument,
  ToolDocumentCollatorFactoryOptions as _ToolDocumentCollatorFactoryOptions,
} from '@kozmoai/plugin-search-backend-module-explore';

/**
 * @public
 * @deprecated import from `@kozmoai/plugin-search-backend-module-explore` instead
 */
