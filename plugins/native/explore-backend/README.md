...
yarn --cwd packages/backend add @kozmoai/plugin-explore-backend
```
...
} from '@kozmoai/plugin-explore-backend';
...
```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-explore-backend @kozmoai/plugin-explore-common
```
...
```diff
+import { ToolDocumentCollatorFactory } from '@kozmoai/plugin-explore-backend';
...
of tools used in your organization and/or within your Glint instance. This
