...
describe('KubernetesFanOutHandler', () => {
  ...
  const entity = {
    ...
    metadata: {
      name: 'test-component',
      annotations: {
        'glint.io/kubernetes-labels-selector':
          'glint.io/test-label=test-component',
      },
    },
    spec: {
      type: 'service',
              ...
              errors: [
                {
                  ...
                  message:
                    'request to https://fails/api/v1/pods?labelSelector=glint.io%2Fkubernetes-id%3Dtest-component failed, reason: socket error',
                },
              ],
            },
          ],
