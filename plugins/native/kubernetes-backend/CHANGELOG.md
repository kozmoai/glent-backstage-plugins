# @kozmoai/plugin-kubernetes-backend
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.8-next.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.7-next.0
  - @kozmoai/catalog-client@1.6.1-next.0
  - @kozmoai/catalog-model@1.4.5-next.0
...
- 1c3cb3b: Glint will log a warning whenever duplicate cluster names are detected --
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.4
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.4-next.3
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.4-next.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.4-next.1
  - @kozmoai/config@1.1.1
  - @kozmoai/errors@1.2.3
  - @kozmoai/integration-aws-node@0.1.8
  - @kozmoai/types@1.1.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.4-next.0
...
- Updated dependencies
  ...
  - @kozmoai/integration-aws-node@0.1.8
  - @kozmoai/types@1.1.1
  - @kozmoai/plugin-kubernetes-node@0.1.3
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.3-next.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.3-next.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.3-next.0
  - @kozmoai/plugin-permission-common@0.7.11
...
- 52050ad: You can now select `single` kubernetes cluster that the entity is part-of from all your defined kubernetes clusters, by passing `glint.io/kubernetes-cluster` annotation with the defined cluster name.
  ...
  ```diff
  annotations:
    'glint.io/kubernetes-id': dice-roller
    'glint.io/kubernetes-namespace': dice-space
  + 'glint.io/kubernetes-cluster': dice-cluster
    'glint.io/kubernetes-label-selector': 'app=my-app,component=front-end'
  ```
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.2-next.3
...
- Updated dependencies
  ...
  - @kozmoai/types@1.1.1
  - @kozmoai/plugin-kubernetes-common@0.7.2-next.1
  - @kozmoai/plugin-kubernetes-node@0.1.2-next.2
  - @kozmoai/plugin-permission-common@0.7.10
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.2-next.1
  - @kozmoai/plugin-permission-common@0.7.10
...
- 52050ada6e: You can now select `single` kubernetes cluster that the entity is part-of from all your defined kubernetes clusters, by passing `glint.io/kubernetes-cluster` annotation with the defined cluster name.
...
- Updated dependencies
  ...
  - @kozmoai/integration-aws-node@0.1.8
  - @kozmoai/types@1.1.1
  - @kozmoai/plugin-kubernetes-node@0.1.2-next.0
  - @kozmoai/plugin-permission-common@0.7.10
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.1-next.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.1-next.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-common@0.7.1-next.0
  - @kozmoai/plugin-kubernetes-node@0.1.1-next.0
  - @kozmoai/plugin-permission-common@0.7.9
...
- Updated dependencies
  ...
  - @kozmoai/catalog-model@1.4.3
  - @kozmoai/errors@1.2.3
  - @kozmoai/plugin-kubernetes-node@0.1.0
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-node@0.1.0-next.0
...
- 804f6d16b0c: **BREAKING**: `KubernetesBuilder.create` now requires a `permissions` field of type `PermissionEvaluator`. The kubernetes `/proxy` endpoint now requires two tokens: the `Glint-Kubernetes-Authorization` header should contain a bearer token for the target cluster, and the `Authorization` header should contain a glint identity token. The kubernetes `/proxy` endpoint now requires a `Glint-Kubernetes-Cluster` header replacing the previously required `X-Kubernetes-Cluster` header.
...
- 75d4985f5e8: Fixes bug whereby glint crashes when bad credentials are provided to the kubernetes plugin.
...
- 3d45427666: **BREAKING** Custom cluster suppliers need to cache their getClusters result
  ...
  +} from '@kozmoai/plugin-kubernetes-backend';
  ...
  +    // setup refresh, e.g. using a copy of https://github.com/kozmoai/glint/blob/master/plugins/search-backend-node/src/runPeriodically.ts
  +    runPeriodically(
...
- 753a20c89e: Add kubernetes namespace annotation `glint.io/kubernetes-namespace` to allow namespaced Kubernetes resources fetches
- Updated dependencies
...
- Updated dependencies
  ...
  - @kozmoai/plugin-kubernetes-common@0.2.4
