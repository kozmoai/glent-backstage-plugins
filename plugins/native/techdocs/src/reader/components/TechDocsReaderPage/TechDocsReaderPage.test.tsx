...
import { Page } from '@kozmoai/core-components';
...
jest.mock('@kozmoai/core-components', () => ({
  ...jest.requireActual('@kozmoai/core-components'),
  Page: jest.fn(),
}));
...
describe('<TechDocsReaderPage />', () => {
  ...
  beforeEach(() => {
    const realPage = jest.requireActual('@kozmoai/core-components').Page;
