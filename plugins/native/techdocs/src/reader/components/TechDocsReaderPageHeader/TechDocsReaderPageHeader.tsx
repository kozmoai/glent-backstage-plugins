...
import {
  ...
  TechDocsMetadata,
} from '@kozmoai/plugin-techdocs-react';
import {
  EntityRefLink,
  EntityRefLinks,
  getEntityRelations,
} from '@kozmoai/plugin-catalog-react';
import { RELATION_OWNED_BY, CompoundEntityRef } from '@kozmoai/catalog-model';
import { Header, HeaderLabel } from '@kozmoai/core-components';
import { useRouteRef, configApiRef, useApi } from '@kozmoai/core-plugin-api';
 ...
 *
 * @public
 * @deprecated No need to pass down properties anymore. The component consumes data from `TechDocsReaderPageContext` instead. Use the {@link @kozmoai/plugin-techdocs-react#useTechDocsReaderPage} hook for custom header.
 */
...
export const TechDocsReaderPageHeader = (
  ...
  const appTitle = configApi.getOptional('app.title') || 'Glint';
