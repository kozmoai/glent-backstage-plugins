...
import { UrlPatternDiscovery } from '@kozmoai/core-app-api';
import { IdentityApi } from '@kozmoai/core-plugin-api';
import { NotFoundError } from '@kozmoai/errors';
import { EventSourcePolyfill } from 'event-source-polyfill';
import { MockConfigApi, MockFetchApi } from '@kozmoai/test-utils';
...
describe('TechDocsStorageClient', () => {
  const mockBaseUrl = 'http://glint:9191/api/techdocs';
  ...
  describe('syncEntityDocs', () => {
    it('should create eventsource without headers', async () => {
      ...
      expect(MockedEventSource).toHaveBeenCalledWith(
        'http://glint:9191/api/techdocs/sync/default/Component/test-component',
