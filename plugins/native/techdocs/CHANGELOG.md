...
- 45e1706328: Continuation of [#9569](https://github.com/kozmoai/glint/pull/9569), fix Tech Docs Reader search position to be the same width as content.
...
- 742434a6ba: Fixed a bug where links to files within a TechDocs site that use the `download` attribute would result in a 404 in cases where the TechDocs backend and Glint frontend application are on the same host.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog@0.7.11-next.1
...
- 1628ca3f49: Fix an issue where the TechDocs sidebar is hidden when the Glint sidebar is pinned at smaller screen sizes
- Updated dependencies
...
- Updated dependencies
  - @kozmoai/plugin-search@0.5.3
  - @kozmoai/plugin-catalog@0.7.6
...
- d90dad84b0: Switch to using `LogViewer` component from `@kozmoai/core-components` to display build logs.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog@0.6.17
  - @kozmoai/plugin-catalog-react@0.5.1
  - @kozmoai/plugin-search@0.4.13
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog@0.6.15
  - @kozmoai/plugin-catalog-react@0.4.6
  - @kozmoai/plugin-search@0.4.11
...
- 434dfc5d4: Display [metadata.title](https://glint.io/docs/features/software-catalog/descriptor-format#title-optional) for components on the TechDocs homepage, if defined; otherwise fall back to `metadata.name` as displayed before.
- Updated dependencies
  - @kozmoai/plugin-catalog-react@0.4.5
  - @kozmoai/integration@0.6.3
  - @kozmoai/core-components@0.4.0
  - @kozmoai/plugin-catalog@0.6.14
  - @kozmoai/plugin-search@0.4.9
...
- 787bc0826: The TechDocs plugin has completed the migration to the Composability API. In
  ...
  [cacl]: https://github.com/kozmoai/glint/blob/master/packages/create-app/CHANGELOG.md

### Patch Changes

- 90c68a2ca: Fix Techdocs feedback icon link for GitHub URLs
- Updated dependencies
  - @kozmoai/plugin-catalog@0.6.13
...
- 11c370af2: Optimize load times by only fetching entities with the `glint.io/techdocs-ref` annotation
...
- 03bf17e9b: Improve the responsiveness of the EntityPage UI. With this the Header component should scale with the screen size & wrapping should not cause overflowing/blocking of links. Additionally enforce the Pages using the Grid Layout to use it across all screen sizes & to wrap as intended.
  ...
  To benefit from the improved responsive layout, the `EntityPage` in existing Glint applications should be updated to set the `xs` column size on each grid item in the page, as this does not default. For example:
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-react@0.3.1
...
- 94a54dd47: Added a `migrateDocsCase()` method to TechDocs publishers, along with
  ...
  See [#4367](https://github.com/kozmoai/glint/issues/4367) for details.
...
- bebd1c4fe: Remove the `@kozmoai/techdocs-common` dependency to not pull in backend config schemas in the frontend.
...
- Updated dependencies [08142b256]
- Updated dependencies [b51ee6ece]
  - @kozmoai/techdocs-common@0.4.0
  - @kozmoai/test-utils@0.1.7
...
- Updated dependencies [27f2af935]
  - @kozmoai/core-api@0.2.8
  - @kozmoai/core@0.4.3
  - @kozmoai/plugin-catalog@0.2.9
  - @kozmoai/techdocs-common@0.3.1
...
- Updated dependencies [a8573e53b]
  ...
  - @kozmoai/core@0.4.2
  - @kozmoai/test-utils@0.1.6
  - @kozmoai/plugin-catalog@0.2.8
  - @kozmoai/techdocs-common@0.3.0
...
- Updated dependencies [700a212b4]
  - @kozmoai/plugin-catalog@0.2.4
  - @kozmoai/catalog-model@0.3.1
  - @kozmoai/core-api@0.2.3
...
- Updated dependencies [8b7737d0b]
  - @kozmoai/core@0.3.1
  - @kozmoai/plugin-catalog@0.2.2
  - @kozmoai/test-utils@0.1.3
...
- 57b54c8ed: While techdocs fetches site name and metadata for the component, the page title was displayed as '[object Object] | Glint'. This has now been fixed to display the component ID if site name is not present or being fetched.
