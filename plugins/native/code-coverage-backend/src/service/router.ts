...
import { CatalogApi, CatalogClient } from '@kozmoai/catalog-client';
import {
...
import { InputError, NotFoundError } from '@kozmoai/errors';
...
import { getEntitySourceLocation } from '@kozmoai/catalog-model';
  ...
  router.get('/file-content', async (req, res) => {
    ...
    if (!sourceLocation) {
      throw new InputError(
        `No "glint.io/source-location" annotation on entity ${entity}`,
      );
    }
