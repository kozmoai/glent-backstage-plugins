...
import { HumanDuration, JsonObject } from '@kozmoai/types';
...
// TODO(pjungermann): validation could be improved similar to `convertToHumanDuration` at @kozmoai/backend-tasks
