# @kozmoai/plugin-events-backend-module-aws-sqs
...
- a5de745ac17: Renamed `awsSqsConsumingEventPublisherEventsModule` to `eventsModuleAwsSqsConsumingEventPublisher` to match the [recommended naming patterns](https://glint.io/docs/backend-system/architecture/naming-patterns).
...
- d3ecb2382d: Adds a new module `aws-sqs` for plugin-events-backend.
  ...
  https://github.com/kozmoai/glint/tree/master/plugins/events-backend-module-aws-sqs/README.md.
