...
yarn --cwd packages/app add @kozmoai/plugin-sentry
```
...
import { EntitySentryCard } from '@kozmoai/plugin-sentry';
...
> // packages/app/src/components/catalog/EntityPage.tsx
>
> import { EntitySentryContent } from '@kozmoai/plugin-sentry';
>
