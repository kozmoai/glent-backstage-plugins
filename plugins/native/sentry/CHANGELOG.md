...
- 075d3dc5a: The plugin uses the `proxy-backend` instead of a custom `sentry-backend`.
  ...
  ```ts
  import { createApiFactory } from '@kozmoai/core';
  import { MockSentryApi, sentryApiRef } from '@kozmoai/plugin-sentry';
  ...
  ...
      "@kozmoai/plugin-scaffolder-backend": "^0.3.2",
  -   "@kozmoai/plugin-sentry-backend": "^0.1.3",
      "@kozmoai/plugin-techdocs-backend": "^0.3.0",
  ...
  ```
