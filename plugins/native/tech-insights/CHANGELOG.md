...
- 22963209d23: Added the possibility to customize the check description in the scorecard component.
  ...
  As an example, the description could change depending on the check result. Refer to the [README](https://github.com/kozmoai/glint/blob/master/plugins/tech-insights/README.md#adding-custom-rendering-components) file for more details
...
- f7e99ac1d8: Added the possibility to display check results of different types on a single scorecard.
  ...
  See the [README](https://github.com/kozmoai/glint/tree/master/plugins/tech-insights/README.md) for more details.
