# @kozmoai/plugin-analytics-module-ga
...
- b40a0ccc4d: Added the ability to capture and set user IDs from Glint's `identityApi`. For full instructions on how to
  set this up, see [the User ID section of its README](https://github.com/kozmoai/glint/tree/master/plugins/analytics-module-ga#user-ids)
- Updated dependencies
