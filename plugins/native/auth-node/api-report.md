## API Report File for "@kozmoai/plugin-auth-node"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { GlintIdentityResponse as GlintIdentityResponse_2 } from '@kozmoai/plugin-auth-node';
import { GlintSignInResult as GlintSignInResult_2 } from '@kozmoai/plugin-auth-node';
...
export class DefaultIdentityClient implements IdentityApi {
  // @deprecated
  authenticate(token: string | undefined): Promise<GlintIdentityResponse>;
...
export function prepareGlintIdentityResponse(
  result: GlintSignInResult_2,
): GlintIdentityResponse_2;
