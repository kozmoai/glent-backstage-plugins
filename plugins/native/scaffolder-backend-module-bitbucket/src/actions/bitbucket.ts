 ...
 * @public
 * @deprecated in favor of "createPublishBitbucketCloudAction" by \@kozmoai/plugin-scaffolder-backend-module-bitbucket-cloud and "createPublishBitbucketServerAction" by \@kozmoai/plugin-scaffolder-backend-module-bitbucket-server
 */
