# @kozmoai/plugin-api-docs-module-protoc-gen-doc
...
yarn --cwd packages/app add @kozmoai/plugin-api-docs-module-protoc-gen-doc
```
...
```ts
import { grpcDocsApiWidget } from '@kozmoai/plugin-api-docs-module-protoc-gen-doc';
