...
import { Entity, isGroupEntity } from '@kozmoai/catalog-model';
...
import { EventParams, EventSubscriber } from '@kozmoai/plugin-events-node';
...
export interface GithubOrgEntityProviderOptions {
   ...
   *
   * @example "https://github.com/kozmoai"
   */
  orgUrl: string;
   ...
   * {@link @kozmoai/backend-tasks#PluginTaskScheduler.createScheduledTaskRunner}
  ...
  implements EntityProvider, EventSubscriber
{
  ...
  /** {@inheritdoc @kozmoai/plugin-catalog-backend#EntityProvider.getProviderName} */
  getProviderName() {
    return `GithubOrgEntityProvider:${this.options.id}`;
  }

  /** {@inheritdoc @kozmoai/plugin-catalog-backend#EntityProvider.connect} */
  ...
  /** {@inheritdoc @kozmoai/plugin-events-node#EventSubscriber.onEvent} */
  ...
  /** {@inheritdoc @kozmoai/plugin-events-node#EventSubscriber.supportsEventTopics} */
