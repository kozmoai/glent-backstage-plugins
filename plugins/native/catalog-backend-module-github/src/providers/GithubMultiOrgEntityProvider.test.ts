...
import { GithubCredentialsProvider } from '@kozmoai/integration';
...
jest.mock('@kozmoai/integration', () => ({
  ...jest.requireActual('@kozmoai/integration'),
          ...
          added: [
            ...
            },
            {
              entity: {
                ...
                metadata: {
                  annotations: {
                    'glint.io/edit-url': 'https://example.com',
                    'glint.io/managed-by-location':
                      'url:https://github.com/orgs/orgA/teams/team',
                    'glint.io/managed-by-origin-location':
                      'url:https://github.com/orgs/orgA/teams/team',
