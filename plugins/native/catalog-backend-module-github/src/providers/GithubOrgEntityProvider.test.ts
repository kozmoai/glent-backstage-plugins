...
import { GroupEntity, UserEntity } from '@kozmoai/catalog-model';
import {
...
describe('GithubOrgEntityProvider', () => {
          ...
          },
          {
            entity: {
              ...
              metadata: {
                annotations: {
                  'glint.io/managed-by-location':
                    'url:https://https://github.com/orgs/glint/teams/team',
                  'glint.io/managed-by-origin-location':
                    'url:https://https://github.com/orgs/glint/teams/team',
  ...
  describe('withLocations', () => {
    it('should set location for user', () => {
      ...
      expect(withLocations('https://github.com', 'glint', entity)).toEqual({
        apiVersion: 'glint.io/v1alpha1',
        kind: 'User',
        metadata: {
          name: 'user-name',
    ...
    it('should set location for group', () => {
      const entity: GroupEntity = {
        ...
        metadata: {
          name: 'group-name',
          annotations: {
            'github.com/team-slug': 'glint/mygroup',
          },
        },
        spec: {
          type: 'team',
      ...
      expect(withLocations('https://github.com', 'glint', entity)).toEqual({
        ...
        metadata: {
          ...
          annotations: {
            'glint.io/managed-by-location':
              'url:https://github.com/orgs/glint/teams/mygroup',
            'glint.io/managed-by-origin-location':
              'url:https://github.com/orgs/glint/teams/mygroup',
            'github.com/team-slug': 'glint/mygroup',
          },
          ...
          },
          {
            ...
            entity: {
              metadata: {
                annotations: {
                  'glint.io/managed-by-location':
                    'url:https://github.com/orgs/glint/teams/team',
                  'glint.io/managed-by-origin-location':
                    'url:https://github.com/orgs/glint/teams/team',
                  'github.com/team-slug': 'blah/team',
                },
        ...
        removed: [
          {
            ...
            entity: {
              metadata: {
                annotations: {
                  'glint.io/managed-by-location':
                    'url:https://github.com/orgs/glint/teams/mygroup-with-spaces',
                  'glint.io/managed-by-origin-location':
                    'url:https://github.com/orgs/glint/teams/mygroup-with-spaces',
                },
