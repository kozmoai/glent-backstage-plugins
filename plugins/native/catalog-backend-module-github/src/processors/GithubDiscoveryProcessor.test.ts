...
import { LocationSpec } from '@kozmoai/plugin-catalog-node';
...
describe('GithubDiscoveryProcessor', () => {
  ...
  describe('handles repositories', () => {
    ...
    it('output all repositories', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/kozmoai/*/blob/master/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          ...
          {
            name: 'demo',
            url: 'https://github.com/kozmoai/demo',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/kozmoai/glint/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target: 'https://github.com/kozmoai/demo/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('output repositories with wildcards default branch option', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/kozmoai/*/blob/-/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
            name: 'glint',
            url: 'https://github.com/kozmoai/tech-docs',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/kozmoai/tech-docs/blob/main/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('output repositories with wildcards default branch option without catalog-info patch or branch match', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/kozmoai',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
    ...
    it('output repositories with wildcards', async () => {
      ...
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          ...
          {
            name: 'techdocs-cli',
            url: 'https://github.com/kozmoai/techdocs-cli',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
          ...
          },
          {
            ...
            url: 'https://github.com/kozmoai/techdocs-container',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
          ...
          {
            name: 'techdocs-durp',
            url: 'https://github.com/kozmoai/techdocs-durp',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: null,
      ...
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/kozmoai/techdocs-cli/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
      expect(emitter).toHaveBeenCalledWith({
        ...
        location: {
          type: 'url',
          target:
            'https://github.com/kozmoai/techdocs-container/blob/master/catalog.yaml',
          presence: 'optional',
        },
      });
    });
    ...
    it('filter unrelated and archived repositories', async () => {
      const location: LocationSpec = {
        type: 'github-discovery',
        target: 'https://github.com/kozmoai/test/blob/master/catalog.yaml',
      };
      mockGetOrganizationRepositories.mockResolvedValueOnce({
        repositories: [
          {
            name: 'abstest',
            url: 'https://github.com/kozmoai/abctest',
            isArchived: false,
            isFork: false,
            repositoryTopics: { nodes: [] },
            defaultBranchRef: {
          ...
          {
            name: 'test',
            url: 'https://github.com/kozmoai/test',
            isArchived: false,
            isFork: false,
            repositoryTopics: { nodes: [] },
            defaultBranchRef: {
          ...
          {
            name: 'testxyz',
            url: 'https://github.com/kozmoai/testxyz',
            repositoryTopics: { nodes: [] },
            isArchived: false,
            isFork: false,
            defaultBranchRef: {
