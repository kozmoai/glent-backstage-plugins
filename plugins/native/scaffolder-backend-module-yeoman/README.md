...
```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-scaffolder-backend-module-yeoman
```
...
Yeoman generator should be installed a dependency of your `glint/packages/backend` in `package.json`
