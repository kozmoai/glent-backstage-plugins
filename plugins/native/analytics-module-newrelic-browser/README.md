...
This plugin provides an opinionated implementation of the Glint Analytics API for New Relic Browser. Once installed and configured, analytics events will be sent to New Relic as your users navigate and use your Glint instance.
...
yarn --cwd packages/app add @kozmoai/plugin-analytics-module-newrelic-browser
```
...
import { NewRelicBrowser } from '@kozmoai/plugin-analytics-module-newrelic-browser';
...
import { GoogleAnalytics } from '@kozmoai/plugin-analytics-module-newrelic-browser';
