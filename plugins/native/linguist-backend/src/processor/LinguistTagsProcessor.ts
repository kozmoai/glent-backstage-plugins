...
import { Entity, stringifyEntityRef } from '@kozmoai/catalog-model';
import {
  CatalogProcessor,
  CatalogProcessorCache,
} from '@kozmoai/plugin-catalog-node';
import { DiscoveryService } from '@kozmoai/backend-plugin-api';
import { Languages, LanguageType } from '@kozmoai/plugin-linguist-common';
import fetch from 'node-fetch';
import { Logger } from 'winston';
import { HumanDuration, durationToMilliseconds } from '@kozmoai/types';
...
export interface LinguistTagsProcessorOptions {
   ...
   * and the values should be how they render as glint tags. Keep in mind that glint has character
 ...
 * the tag requirements for glint
 *
