 ...
 */
import { EventParams, EventsService } from '@kozmoai/plugin-events-node';
import { SignalPayload } from '@kozmoai/plugin-signals-node';
...
export class SignalManager {
  ...
  addConnection(ws: WebSocket, identity?: GlintUserInfo) {
    const id = uuid();
