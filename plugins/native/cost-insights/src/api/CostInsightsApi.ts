...
import {
  ...
  Maybe,
  MetricData,
} from '@kozmoai/plugin-cost-insights-common';
...
export type CostInsightsApi = {
   ...
   *
   * This method should be removed once the Glint identity plugin provides the same concept.
   *
   ...
   *   https://glint.io/docs/features/software-catalog/references
