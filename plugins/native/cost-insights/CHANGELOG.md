...
- Updated dependencies
  ...
  - @kozmoai/plugin-cost-insights-common@0.1.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-cost-insights-common@0.1.2-next.0
...
- Updated dependencies
  ...
  - @kozmoai/theme@0.4.1
  - @kozmoai/plugin-cost-insights-common@0.1.1
...
- 6a41175d70: Removed @kozmoai/test-utils dependency, since it was already in the devDependencies where it belongs. The main benefit is that this will exclude better-sqlite3 from the production build.
...
- daf4b33e34: Add name property to Group
- Updated dependencies
  - @kozmoai/plugin-cost-insights-common@0.1.1-next.0
...
- 3e032a5de2: Move cost-insights data specific API types (non react) into an @kozmoai/plugin-cost-insights-common
...
- Updated dependencies
  ...
  - @kozmoai/plugin-cost-insights-common@0.1.0
...
- Updated dependencies
  ...
  - @kozmoai/plugin-cost-insights-common@0.1.0-next.0
...
- 7858c2abdc: Fixed an accidental re-export of `@kozmoai/test-utils` that broke this plugin in the most recent release.
