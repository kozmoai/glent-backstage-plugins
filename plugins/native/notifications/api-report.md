## API Report File for "@kozmoai/plugin-notifications"
...
import { NotificationStatus } from '@kozmoai/plugin-notifications-common';
...
// @public (undocumented)
export const notificationsPlugin: GlintPlugin<
  {
