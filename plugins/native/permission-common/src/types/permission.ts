 ...
 * may wish to protect.
 *
 * To evaluate authorization, a permission is paired with a Glint identity (the "who") and
 ...
 * @public
 * @deprecated Use {@link @kozmoai/plugin-permission-common#PermissionEvaluator} instead
 */
