...
import { JsonPrimitive } from '@kozmoai/types';
...
/**
 * A definitive decision returned by the {@link @kozmoai/plugin-permission-node#PermissionPolicy}.
 *
 * @remarks
 *
...
/**
 * A conditional decision returned by the {@link @kozmoai/plugin-permission-node#PermissionPolicy}.
 *
 * @remarks
 *
...
/**
 * A decision returned by the {@link @kozmoai/plugin-permission-node#PermissionPolicy}.
 *
 * @public
 */
 ...
 * {@link @kozmoai/plugin-permission-node#PermissionPolicy} interface and the permission backend
...
export interface PermissionEvaluator {
   ...
   * {@link @kozmoai/plugin-permission-node#PermissionPolicy}. This method is useful when the
...
export type EvaluatorRequestOptions = {
   ...
   * `@kozmoai/backend-plugin-api`. Frontend plugins should not need to inject
