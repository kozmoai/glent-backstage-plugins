...
import { getVoidLogger } from '@kozmoai/backend-common';
...
describe('helpers', () => {
  ...
  describe('getRepoUrlFromLocationAnnotation', () => {
    it.each`
      ...
      ${'https://github.com/kozmoai/glint'}                                | ${'https://github.com/kozmoai/glint'}                                | ${undefined}
      ${'https://github.com/kozmoai/glint/tree/main/examples/techdocs/'}   | ${'https://github.com/kozmoai/glint/tree/main/examples/techdocs/'}   | ${'https://github.com/kozmoai/glint/edit/main/examples/techdocs/docs'}
      ${'https://github.com/kozmoai/glint/tree/main/'}                     | ${'https://github.com/kozmoai/glint/tree/main/'}                     | ${'https://github.com/kozmoai/glint/edit/main/docs'}
      ${'https://gitlab.com/kozmoai/glint'}                                | ${'https://gitlab.com/kozmoai/glint'}                                | ${undefined}
      ${'https://gitlab.com/kozmoai/glint/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/kozmoai/glint/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/kozmoai/glint/-/edit/main/examples/techdocs/docs'}
      ${'https://gitlab.com/kozmoai/glint/-/blob/main/'}                   | ${'https://gitlab.com/kozmoai/glint/-/blob/main/'}                   | ${'https://gitlab.com/kozmoai/glint/-/edit/main/docs'}
    ...
    it.each`
      url                                                                        | repo_url                                                                   | edit_uri
      ${'https://github.com/kozmoai/glint/tree/main/examples/techdocs/'}   | ${'https://github.com/kozmoai/glint/tree/main/examples/techdocs/'}   | ${'https://github.com/kozmoai/glint/edit/main/examples/techdocs/custom/folder'}
      ${'https://github.com/kozmoai/glint/tree/main/'}                     | ${'https://github.com/kozmoai/glint/tree/main/'}                     | ${'https://github.com/kozmoai/glint/edit/main/custom/folder'}
      ${'https://gitlab.com/kozmoai/glint/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/kozmoai/glint/-/blob/main/examples/techdocs/'} | ${'https://gitlab.com/kozmoai/glint/-/edit/main/examples/techdocs/custom/folder'}
      ${'https://gitlab.com/kozmoai/glint/-/blob/main/'}                   | ${'https://gitlab.com/kozmoai/glint/-/blob/main/'}                   | ${'https://gitlab.com/kozmoai/glint/-/edit/main/custom/folder'}
    `(
    ...
    it.each`
      url
      ${'https://bitbucket.org/kozmoai/glint/src/master/examples/techdocs/'}
      ${'https://bitbucket.org/kozmoai/glint/src/master/'}
  ...
  describe('patchMkdocsYmlPreBuild', () => {
    ...
    it('should add edit_uri to mkdocs.yml', async () => {
      const parsedLocationAnnotation: ParsedLocationAnnotation = {
        type: 'url',
        target: 'https://github.com/kozmoai/glint',
      };
      ...
      expect(updatedMkdocsYml.toString()).toContain(
        'repo_url: https://github.com/kozmoai/glint',
      );
    });
    ...
    it('should not override existing edit_uri in mkdocs.yml', async () => {
      ...
      expect(updatedMkdocsYml.toString()).toContain(
        'edit_uri: https://github.com/kozmoai/glint/edit/main/docs',
      );
      expect(updatedMkdocsYml.toString()).not.toContain(
