...
import { isChildPath } from '@kozmoai/backend-common';
...
/**
 * Return the source url for MkDocs based on the glint.io/techdocs-ref annotation.
...
export const getRepoUrlFromLocationAnnotation = (
  ...
  if (locationType === 'url') {
    ...
    if (
      ...
      // handle the case where a user manually writes url:https://github.com/kozmoai/glint i.e. without /blob/...
