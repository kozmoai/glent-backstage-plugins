...
import { useApi, useRouteRef } from '@kozmoai/core-plugin-api';
import { CatalogEntityDocument } from '@kozmoai/plugin-catalog-common';
import { catalogApiRef, entityRouteRef } from '@kozmoai/plugin-catalog-react';
import type { SearchDocument } from '@kozmoai/plugin-search-common';
import {
  SearchBar,
