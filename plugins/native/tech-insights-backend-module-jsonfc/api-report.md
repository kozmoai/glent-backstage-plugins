## API Report File for "@kozmoai/plugin-tech-insights-backend-module-jsonfc"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { BackendFeature } from '@kozmoai/backend-plugin-api';
import { BooleanCheckResult } from '@kozmoai/plugin-tech-insights-common';
import { CheckResponse } from '@kozmoai/plugin-tech-insights-common';
import { CheckValidationResponse } from '@kozmoai/plugin-tech-insights-node';
...
import { TechInsightCheckRegistry } from '@kozmoai/plugin-tech-insights-node';
