...
import { useApp, useRouteRef } from '@kozmoai/core-plugin-api';
...
import {
  ...
  TemplateGroups,
} from '@kozmoai/plugin-scaffolder-react/alpha';
...
import { parseEntityRef, stringifyEntityRef } from '@kozmoai/catalog-model';
...
export const TemplateListPage = (props: TemplateListPageProps) => {
  ...
  const additionalLinksForEntity = useCallback(
    (template: TemplateEntityV1beta3) => {
      ...
      return template.metadata.annotations?.['glint.io/techdocs-ref'] &&
        viewTechDocsLink
        ? [
            {
