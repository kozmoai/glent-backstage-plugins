...
import { scaffolderApiRef } from '@kozmoai/plugin-scaffolder-react';
...
jest.mock('@kozmoai/plugin-scaffolder-react', () => ({
  ...jest.requireActual('@kozmoai/plugin-scaffolder-react'),
  useTaskEventStream: () => ({
    cancelled: false,
    loading: true,
    stepLogs: {},
