...
export const exampleTools = [
  ...
  },
  {
    title: 'GraphiQL',
    description:
      'Integrates GraphiQL as a tool to browse GraphiQL endpoints inside Glint.',
    url: '/graphiql',
    image:
  ...
  },
  {
    ...
    description:
      'Create GitOps-managed clusters with Glint. Currently supports EKS flavors and profiles like Machine Learning Ops (MLOps)',
    url: '/gitops-clusters',
