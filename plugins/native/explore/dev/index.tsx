...
import { CatalogEntityPage, EntityLayout } from '@kozmoai/plugin-catalog';
import { CatalogApi, catalogApiRef } from '@kozmoai/plugin-catalog-react';
import { exploreToolsConfigRef } from '@kozmoai/plugin-explore-react';
  ...
  async getEntityByRef(): Promise<Entity | undefined> {
    return {
      ...
      metadata: {
        name: 'example',
        annotations: {
          'glint.io/managed-by-location': 'file:/path/to/catalog-info.yaml',
        },
      },
      spec: {
        type: 'service',
