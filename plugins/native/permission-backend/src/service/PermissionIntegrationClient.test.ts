...
describe('PermissionIntegrationClient', () => {
  describe('applyConditions', () => {
    ...
    const mockBaseUrl = 'http://glint:9191';
    ...
    beforeAll(() => {
      ...
      server.use(
        rest.post(
          `${mockBaseUrl}/plugin-1/.well-known/glint/permissions/apply-conditions`,
  ...
  describe('integration with @kozmoai/plugin-permission-node', () => {
    let server: Server;
