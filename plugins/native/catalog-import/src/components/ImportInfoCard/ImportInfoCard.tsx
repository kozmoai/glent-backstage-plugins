...
import { configApiRef, useApi } from '@kozmoai/core-plugin-api';
...
export const ImportInfoCard = (props: ImportInfoCardProps) => {
  const {
    exampleLocationUrl = 'https://github.com/kozmoai/glint/blob/master/catalog-info.yaml',
    exampleRepositoryUrl = 'https://github.com/kozmoai/glint',
  } = props;

  const configApi = useApi(configApiRef);
  const appTitle = configApi.getOptionalString('app.title') || 'Glint';
  ...
  return (
    <InfoCard
      ...
      deepLink={{
        ...
        link: 'https://glint.io/docs/features/software-catalog/',
      }}
    >
