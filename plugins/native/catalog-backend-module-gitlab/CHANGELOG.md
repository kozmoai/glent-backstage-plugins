# @kozmoai/plugin-catalog-backend-module-gitlab
...
- 90469c02c8c: Renamed `gitlabDiscoveryEntityProviderCatalogModule` to `catalogModuleGitlabDiscoveryEntityProvider` to match the [recommended naming patterns](https://glint.io/docs/backend-system/architecture/naming-patterns).
...
- 81cedb5033: `GitlabDiscoveryEntityProvider`: Add option to configure schedule via `app-config.yaml` instead of in code.
  ...
  https://glint.io/docs/integrations/gitlab/discovery
...
- eea8126171: Add a new provider `GitlabDiscoveryEntityProvider` as replacement for `GitlabDiscoveryProcessor`
  ...
  **After:**
  ...
  import { GitlabDiscoveryEntityProvider } from '@kozmoai/plugin-catalog-backend-module-gitlab';
