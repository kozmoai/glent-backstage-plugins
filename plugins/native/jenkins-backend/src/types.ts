...
/**
 * A build as presented by this plugin to the glint jenkins plugin
 */
export interface GlintBuild extends CommonBuild {
  // added by us
  source?: {
    branchName: string;
    displayName: string;
...
export interface GlintProject extends CommonProject {
  // standard Jenkins
  lastBuild: GlintBuild | null;
