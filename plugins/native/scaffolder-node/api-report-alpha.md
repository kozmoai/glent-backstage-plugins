## API Report File for "@kozmoai/plugin-scaffolder-node"
...
import { TemplateFilter } from '@kozmoai/plugin-scaffolder-node';
import { TemplateGlobal } from '@kozmoai/plugin-scaffolder-node';
