...
import { GlintUserIdentity, IdentityApi } from '@kozmoai/core-plugin-api';
import { VisitsStorageApi } from './VisitsStorageApi';
import { MockStorageApi } from '@kozmoai/test-utils';
...
describe('VisitsStorageApi.create', () => {
  ...
  const mockIdentityApi: IdentityApi = {
    ...
    getGlintIdentity: async () =>
      ({ userEntityRef: 'user:default/guest' } as GlintUserIdentity),
