 ...
 */
import { IdentityApi, StorageApi } from '@kozmoai/core-plugin-api';
import {
  Visit,
  VisitsApi,
...
export class VisitsStorageApi implements VisitsApi {
  ...
  private readonly storageKeyPrefix = '@kozmoai/plugin-home:visits';
  ...
  private async getStorageKey(): Promise<string> {
    const { userEntityRef } = await this.identityApi.getGlintIdentity();
