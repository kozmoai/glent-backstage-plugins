...
The Sonarqube backend plugin has support for the [new backend system](https://glint.io/docs/backend-system/), here's how you can set that up:
...
+ backend.add(import('@kozmoai/plugin-sonarqube-backend'));
  backend.start();
```

## Integrating into a glint instance

This plugin needs to be added to an existing glint instance.

```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-sonarqube-backend
```
...
} from '@kozmoai/plugin-sonarqube-backend';
