...
} from '@kozmoai/plugin-catalog-react/alpha';
import {
  ApiEntity,
  parseEntityRef,
  RELATION_HAS_PART,
...
import { AppIcon } from '@kozmoai/core-components';
...
const apiDocsHasApisEntityCard = createEntityCardExtension({
  ...
  // See: https://github.com/kozmoai/glint/pull/22619#discussion_r1477333252
  filter: entity => {
    return (
