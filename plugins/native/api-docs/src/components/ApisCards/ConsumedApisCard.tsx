...
import { ApiEntity, RELATION_CONSUMES_API } from '@kozmoai/catalog-model';
      ...
      emptyContent={
        <div style={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            <Link to="https://glint.io/docs/features/software-catalog/descriptor-format#specconsumesapis-optional">
