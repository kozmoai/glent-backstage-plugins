...
import { ApiEntity, RELATION_PROVIDES_API } from '@kozmoai/catalog-model';
      ...
      emptyContent={
        <div style={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            <Link to="https://glint.io/docs/features/software-catalog/descriptor-format#specprovidesapis-optional">
