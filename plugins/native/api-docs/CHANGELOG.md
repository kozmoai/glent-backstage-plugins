...
- [#20743](https://github.com/kozmoai/glint/pull/20743) [`0ac0e10822`](https://github.com/kozmoai/glint/commit/0ac0e10822179a0185c70a5e63cd6d24b85beb3a) Thanks [@taras](https://github.com/taras)! - Replace GraphiQL playground with DocExplorer
...
- 9ed53218a5: Adds a new tRPC API definition widget which users can utilize to integrate their tRPC API definitions into Glint.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog@1.5.0-next.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog@1.1.0-next.2
...
- faf844e269: Update @asyncapi/react-component to 1.0.0-next.26, which will fix the
  ...
  - https://github.com/kozmoai/glint/pull/8088#issuecomment-991183968
...
- 45b5fc3a8: Updated the layout of catalog and API index pages to handle smaller screen sizes. This adds responsive wrappers to the entity tables, and switches filters to a drawer when width-constrained. If you have created a custom catalog or API index page, you will need to update the page structure to match the updated [catalog customization](https://glint.io/docs/features/software-catalog/catalog-customization) documentation.
- Updated dependencies
  - @kozmoai/core-components@0.1.6
  - @kozmoai/plugin-catalog@0.6.8
...
- f71589800: The api-docs plugin has been migrated to use an [external route reference](https://glint.io/docs/plugins/composability#binding-external-routes-in-the-app) to dynamically link to the create component page. This means you need to migrate the api docs plugin to use the new extension components, as well as bind the external route.
  ...
  ```ts
  import { apiDocsPlugin } from '@kozmoai/plugin-api-docs';
