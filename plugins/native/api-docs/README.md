...
> The plugin is already added when using `npx @kozmoai/create-app` so you can skip these steps.
...
import { ApiExplorerPage } from '@kozmoai/plugin-api-docs';
...
```tsx
...
import { OpenApiDefinitionWidget, apiDocsConfigRef, defaultDefinitionWidgets } from '@kozmoai/plugin-api-docs';
import { ApiEntity } from '@kozmoai/catalog-model';
