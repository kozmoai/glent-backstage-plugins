...
// ******************************************************************
import { createValidatedOpenApiRouter } from '@kozmoai/backend-openapi-utils';
      ...
      filter: {
        ...
        examples: {
          ...
          'Get orphaned components': {
            value: [
              'kind=component,metadata.annotations.glint.io/orphan=true',
            ],
          },
        },
      },
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              ...
              examples: {
                'Fetch Glint entities': {
                  value: {
                    entityRefs: [
                      'component:default/glint',
                      'api:default/glint',
                    ],
                  },
                },
                'Fetch annotations for glint entity': {
                  value: {
                    entityRefs: ['component:default/glint'],
