...
} from '@kozmoai/plugin-catalog-common';
import {
...
} from '@kozmoai/plugin-search-backend-module-catalog';

/**
 * @public
 * @deprecated import from `@kozmoai/plugin-catalog-node` instead
 */
 ...
 *
 * @public
 * @deprecated use the same type from `@kozmoai/plugin-catalog-common` instead
 */
...
/**
 * @public
 * @deprecated import from `@kozmoai/plugin-search-backend-module-catalog` instead
 */
