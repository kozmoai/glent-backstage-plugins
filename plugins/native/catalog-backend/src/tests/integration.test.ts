...
import { DatabaseManager, getVoidLogger } from '@kozmoai/backend-common';
import {
  Entity,
  EntityPolicies,
  stringifyEntityRef,
    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          name: 'test',
          annotations: {
            'glint.io/managed-by-location': 'url:.',
            'glint.io/managed-by-origin-location': 'url:.',
          },
        },
      },
    ]);
    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          ...
          annotations: {
            'glint.io/managed-by-location': 'url:.',
            'glint.io/managed-by-origin-location': 'url:.',
            'glint.io/view-url': '       javascript:bad()',
            'glint.io/edit-url': '       javascript:alert()',
          },
        },
      },
    ]);
    ...
    await expect(harness.getOutputEntities()).resolves.toEqual({
      'component:default/test': {
        ...
        metadata: expect.objectContaining({
          ...
          annotations: expect.objectContaining({
            'glint.io/view-url':
              'https://glint.io/annotation-rejected-for-security-reasons',
            'glint.io/edit-url':
              'https://glint.io/annotation-rejected-for-security-reasons',
          }),
        }),
    ...
    await harness.setInputEntities([
      {
        ...
        metadata: {
          name: 'test',
          annotations: {
            'glint.io/managed-by-location': 'url:javascript:bad()',
            'glint.io/managed-by-origin-location': 'url:javascript:alert()',
          },
        },
      },
    ]);
