...
function addProcessorAttributes(
  ...
  span.setAttribute('glint.catalog.processor.stage', stage);
  span.setAttribute(
    'glint.catalog.processor.name',
  ...
  implements CatalogProcessingOrchestrator
{
  ...
  private async runPreProcessStep(
    ...
    return await withActiveSpan(tracer, 'ProcessingStage', async stageSpan => {
      ...
      stageSpan.setAttribute('glint.catalog.processor.stage', 'preProcess');
      let res = entity;
  ...
  private async runValidateStep(
    ...
    return await withActiveSpan(tracer, 'ProcessingStage', async stageSpan => {
      addEntityAttributes(stageSpan, entity);
      stageSpan.setAttribute('glint.catalog.processor.stage', 'validate');
