  ...
  describe('github', () => {
    ...
    it('does not override existing annotation', async () => {
      const entity: Entity = {
        ...
        metadata: {
          name: 'my-component',
          annotations: {
            'github.com/project-slug': 'glint/community',
          },
        },
      };
      const location: LocationSpec = {
    ...
    it('should not add annotation for other providers', async () => {
      ...
      const location: LocationSpec = {
        type: 'url',
        target:
          'https://not-in-mock-config.example.com/kozmoai/glint/-/blob/master/catalog-info.yaml',
      };
    ...
    it('does not override existing annotation', async () => {
      const entity: Entity = {
        ...
        metadata: {
          name: 'my-component',
          annotations: {
            'gitlab.com/project-slug': 'glint/community',
          },
        },
      };
      const location: LocationSpec = {
