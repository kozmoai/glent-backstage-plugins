...
import { TestDatabaseId, TestDatabases } from '@kozmoai/backend-test-utils';
    ...
    it.each(databases.eachSupportedId())(
      ...
      async databaseId => {
        ...
        await store.createLocation({
          target:
            'https://github.com/kozmoai/demo/blob/master/catalog-info.yml',
          type: 'url',
        });
          ...
          added: expect.arrayContaining([
            {
              ...
              locationKey:
                'url:https://github.com/kozmoai/demo/blob/master/catalog-info.yml',
            },
          ]),
        });
      },
