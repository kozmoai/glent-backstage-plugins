...
export interface Config {
  ...
  catalog?: {
     ...
     * that regular users of Glint are permitted to register locations
     ...
     * components to a running glint instance.
     */
    readonly?: boolean;
     ...
     * that are defined by the Glint operators at an organization, rather
