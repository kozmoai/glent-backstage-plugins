 ...
 * {@link @kozmoai/plugin-permission-react#usePermission} hook which uses the
 * current entity in context to make an authorization request for the given
 * {@link @kozmoai/plugin-catalog-common#CatalogEntityPermission}.
 *
...
export function useEntityPermission(
  ...
  // https://github.com/kozmoai/glint/pull/10128 is fixed.
