...
import { catalogEntityDeletePermission } from '@kozmoai/plugin-catalog-common/alpha';
...
jest.mock('@kozmoai/plugin-permission-react', () => ({
  ...jest.requireActual('@kozmoai/plugin-permission-react'),
