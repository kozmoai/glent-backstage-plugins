...
import { CodeSnippet, Link, EmptyState } from '@kozmoai/core-components';
...
const useStyles = makeStyles(
  ...
  { name: 'GlintMissingAnnotationEmptyState' },
);
...
function generateYamlExample(
  ...
  const yamlText = `apiVersion: glint.io/v1alpha1
kind: ${kind}
metadata:
  name: ${name}
...
export function MissingAnnotationEmptyState(props: {
  ...
  const url =
    readMoreUrl ||
    'https://glint.io/docs/features/software-catalog/well-known-annotations';
