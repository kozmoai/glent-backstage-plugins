...
import { alertApiRef, configApiRef, useApi } from '@kozmoai/core-plugin-api';
import { Progress, ResponseErrorPanel } from '@kozmoai/core-components';
    ...
    return (
      <>
        <Alert severity="info">
          ...
          protected Glint configuration (location "{state.location}"). If
