...
import { CopyTextButton } from '@kozmoai/core-components';
    ...
    <>
      ...
      <div className={classes.root}>
          ...
          {!!Object.keys(metadata.annotations || {}).length && (
            <List
              ...
              subheader={
                <ListSubheader>
                  Annotations
                  <HelpIcon to="https://glint.io/docs/features/software-catalog/well-known-annotations" />
                </ListSubheader>
              }
            >
        ...
        {!!relations.length && (
          <Container
            title="Relations"
            helpLink="https://glint.io/docs/features/software-catalog/well-known-relations"
          >
        ...
        {!!status.items?.length && (
          <Container
            title="Status"
            helpLink="https://glint.io/docs/features/software-catalog/well-known-statuses"
          >
