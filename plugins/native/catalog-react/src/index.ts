...
/**
 * A frontend library that helps other Glint plugins interact with the catalog
 *
 * @packageDocumentation
 */

export type { CatalogApi } from '@kozmoai/catalog-client';
export { CATALOG_FILTER_EXISTS } from '@kozmoai/catalog-client';
