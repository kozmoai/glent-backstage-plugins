...
import { createRouteRef } from '@kozmoai/core-plugin-api';
import { getOrCreateGlobalSingleton } from '@kozmoai/version-bridge';
 ...
 *
 * If you want to replace the `EntityPage` from `@kozmoai/catalog-plugin` in your app,
