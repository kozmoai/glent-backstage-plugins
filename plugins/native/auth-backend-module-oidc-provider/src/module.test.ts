...
import { decodeOAuthState } from '@kozmoai/plugin-auth-node';
...
describe('authModuleOidcProvider', () => {
  ...
  beforeEach(async () => {
    ...
    const backend = await startTestBackend({
      features: [
        ...
        import('@kozmoai/plugin-auth-backend'),
  ...
  it('should start', async () => {
    const agent = request.agent(glintServer);
