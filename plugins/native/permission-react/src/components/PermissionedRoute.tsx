...
import { useApp } from '@kozmoai/core-plugin-api';
 ...
 * NotFoundErrorPage (see {@link @kozmoai/core-app-api#AppComponents}).
 *
 * @public
 * @deprecated This component no longer works with the most recent version of `@kozmoai/core-app-api` and react-router v6, use {@link RequirePermission} instead.
 */
