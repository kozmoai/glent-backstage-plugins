...
/**
 * @public
 * @deprecated This plugin will be removed in a future release. Please use \@pagerduty/glint-plugin plugin instead (https://www.npmjs.com/package/\@pagerduty/glint-plugin).
 */
...
/**
 * @public
 * @deprecated This plugin and it's cards will be removed in a future release. Please use \@pagerduty/glint-plugin plugin instead (https://www.npmjs.com/package/\@pagerduty/glint-plugin).
 */
