...
`@kozmoai/plugin-search-backend` based on Postgres.
...
See [Glint documentation](https://glint.io/docs/features/search/search-engines#postgres)
for details on how to setup Postgres based search for your Glint instance.
