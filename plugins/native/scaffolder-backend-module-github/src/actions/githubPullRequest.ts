...
import { InputError, CustomErrorBase } from '@kozmoai/errors';
...
export interface CreateGithubPullRequestActionOptions {
  /**
   * An instance of {@link @kozmoai/integration#ScmIntegrationRegistry} that will be used in the action.
   */
  integrations: ScmIntegrationRegistry;
  /**
   * An instance of {@link @kozmoai/integration#GithubCredentialsProvider} that will be used to get credentials for the action.
   */
