# @kozmoai/plugin-badges

The badges plugin offers a set of badges that can be used outside of
your glint deployment, showing information related to data from
...
Also, you need to allow your frontend to access the configuration see <https://glint.io/docs/conf/defining/#visibility> :
...
Here are some samples of badges for the `artists-lookup` service in the Demo Glint site:

- Component: [![Link to artist-lookup in Glint Demo, Component: artist-lookup](https://demo.glint.io/api/badges/entity/default/component/artist-lookup/badge/pingback 'Link to artist-lookup in Glint Demo')](https://demo.glint.io/catalog/default/component/artist-lookup)
- Lifecycle: [![Entity lifecycle badge, lifecycle: experimental](https://demo.glint.io/api/badges/entity/default/component/artist-lookup/badge/lifecycle 'Entity lifecycle badge')](https://demo.glint.io/catalog/default/component/artist-lookup)
- Owner: [![Entity owner badge, owner: team-a](https://demo.glint.io/api/badges/entity/default/component/artist-lookup/badge/owner 'Entity owner badge')](https://demo.glint.io/catalog/default/component/artist-lookup)
- Docs: [![Entity docs badge, docs: artist-lookup](https://demo.glint.io/api/badges/entity/default/component/artist-lookup/badge/docs 'Entity docs badge')](https://demo.glint.io/catalog/default/component/artist-lookup/docs)

## Usage

### Install the package

Install the `@kozmoai/plugin-badges` package in your frontend app package:

```bash
# From your Glint root directory
yarn --cwd packages/app add @kozmoai/plugin-badges
```
...
```ts
// ...
export { badgesPlugin } from '@kozmoai/plugin-badges';
```
...
```ts
import { EntityBadgesDialog } from '@kozmoai/plugin-badges';
...
Note: the above only shows an example for the `defaultEntityPage` for a full example of this you can look at [this EntityPage](https://github.com/kozmoai/glint/blob/1fd9e6f601cabe42af8eb20b5d200ad1988ba309/packages/app/src/components/catalog/EntityPage.tsx#L318)
...
```diff
+ import { badgesPlugin } from '@kozmoai/plugin-badges'
...
- [Backend part of the plugin](https://github.com/kozmoai/glint/tree/master/plugins/badges-backend)
