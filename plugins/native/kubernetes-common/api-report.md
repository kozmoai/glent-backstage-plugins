## API Report File for "@kozmoai/plugin-kubernetes-common"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { BasicPermission } from '@kozmoai/plugin-permission-common';
import { Entity } from '@kozmoai/catalog-model';
import { FetchResponse as FetchResponse_2 } from '@kozmoai/plugin-kubernetes-common';
import type { JsonObject } from '@kozmoai/types';
import type { JsonValue } from '@kozmoai/types';
import { ObjectsByEntityResponse as ObjectsByEntityResponse_2 } from '@kozmoai/plugin-kubernetes-common';
