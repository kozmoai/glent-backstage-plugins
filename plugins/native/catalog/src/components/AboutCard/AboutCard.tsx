...
import { isTemplateEntityV1beta3 } from '@kozmoai/plugin-scaffolder-common';
import { parseEntityRef } from '@kozmoai/catalog-model';
import { useEntityPermission } from '@kozmoai/plugin-catalog-react/alpha';
import { catalogEntityRefreshPermission } from '@kozmoai/plugin-catalog-common/alpha';

const TECHDOCS_ANNOTATION = 'glint.io/techdocs-ref';

const TECHDOCS_EXTERNAL_ANNOTATION = 'glint.io/techdocs-entity';
