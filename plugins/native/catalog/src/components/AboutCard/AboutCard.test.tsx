...
} from '@kozmoai/integration-react';
...
import { RELATION_OWNED_BY } from '@kozmoai/catalog-model';
import React from 'react';
import { screen } from '@testing-library/react';
import userEvent from '@testing-library/user-event';
import { permissionApiRef } from '@kozmoai/plugin-permission-react';
...
describe('<AboutCard />', () => {
  ...
  it('renders "view source" link', async () => {
      ...
      metadata: {
        ...
        annotations: {
          'glint.io/source-location':
            'url:https://github.com/kozmoai/glint/blob/master/software.yaml',
        },
      },
      spec: {
        owner: 'guest',
    ...
    expect(screen.getByText('View Source').closest('a')).toHaveAttribute(
      'href',
      'https://github.com/kozmoai/glint/blob/master/software.yaml',
    );
  });
  ...
  it('renders "edit metadata" button', async () => {
    const entity = {
      ...
      metadata: {
        ...
        annotations: {
          'glint.io/edit-url':
            'https://github.com/kozmoai/glint/edit/master/software.yaml',
        },
      },
      spec: {
        owner: 'guest',
  ...
  it.each([
    'url:https://glint.io/catalog-info.yaml',
    ...
    const entity = {
      ...
      metadata: {
        annotations: {
          'glint.io/managed-by-location': location,
        },
        name: 'software',
      },
      spec: {
  ...
  it('renders techdocs lin when 3rdparty', async () => {
    const entity = {
      ...
      metadata: {
        name: 'software',
        annotations: {
          'glint.io/techdocs-entity': 'system:default/example',
        },
      },
      spec: {
        owner: 'guest',
  ...
  it.each([
    ...
    {
      testName: 'apiVersion is not scaffolder.glint.io/v1beta3',
      entity: {
        apiVersion: 'v1',
        kind: 'Template',
        metadata: {
