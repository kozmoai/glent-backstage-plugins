...
import { configApiRef, useApi, useRouteRef } from '@kozmoai/core-plugin-api';
import {
  CatalogFilterLayout,
  EntityListProvider,
  UserListFilterKind,
...
import { useTranslationRef } from '@kozmoai/core-plugin-api/alpha';

import { CatalogTableColumnsFunc } from '../CatalogTable/types';
import { catalogEntityCreatePermission } from '@kozmoai/plugin-catalog-common/alpha';
import { usePermission } from '@kozmoai/plugin-permission-react';
import { DefaultFilters } from '@kozmoai/plugin-catalog-react';
...
export function BaseCatalogPage(props: BaseCatalogPageProps) {
  ...
  const orgName =
    useApi(configApiRef).getOptionalString('organization.name') ?? 'Glint';
