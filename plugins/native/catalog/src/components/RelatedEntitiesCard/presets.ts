...
import { EntityTable } from '@kozmoai/plugin-catalog-react';
import { TableColumn } from '@kozmoai/core-components';
...
export const componentEntityHelpLink: string =
  'https://glint.io/docs/features/software-catalog/descriptor-format#kind-component';
...
export const resourceEntityHelpLink: string =
  'https://glint.io/docs/features/software-catalog/descriptor-format#kind-resource';
...
export const systemEntityHelpLink: string =
  'https://glint.io/docs/features/software-catalog/descriptor-format#kind-system';
