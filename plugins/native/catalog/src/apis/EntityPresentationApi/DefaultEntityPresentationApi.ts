...
/**
 * Default implementation of the {@link @kozmoai/plugin-catalog-react#EntityPresentationApi}.
 *
 * @public
 */
export class DefaultEntityPresentationApi implements EntityPresentationApi {
  ...
  /** {@inheritdoc @kozmoai/plugin-catalog-react#EntityPresentationApi.forEntity} */
  forEntity(
