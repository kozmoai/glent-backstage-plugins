...
- 1e5b7d993a: Added the `DefaultEntityPresentationApi`, which is an implementation of the
  `EntityPresentationApi` that `@kozmoai/plugin-catalog-react` exposes through
...
- [#20777](https://github.com/kozmoai/glint/pull/20777) [`eb817ee6d4`](https://github.com/kozmoai/glint/commit/eb817ee6d4720322773389dbe6ed20d6fc80a541) Thanks [@is343](https://github.com/is343)! - Fix spacing inconsistency with links and labels in headers
...
- 28f1ab2e1a: The catalog plugin no longer implements the experimental reconfiguration API. The create button title can now instead be configured using the new experimental internationalization API, via the `catalogTranslationRef` exported at `/alpha`. For example:
  ...
  ```ts
  import { catalogTranslationRef } from '@kozmoai/plugin-catalog/alpha';
...
- 7c4a8e4d5f: Create an experimental `CatalogSearchResultItemExtension` for declarative integration with Glint; it can be accessed via the `/alpha` import.
...
- dcaf1cb418: Previously, the color of the Entity Context Menu (in the Entity Page Header) was hardcoded as `white`.
  ...
  ```typescript
  export function createThemeOverrides(theme: GlintTheme): Overrides {
    return {
...
- c689d7a94c: **DEPRECATION**: The `FilteredEntityLayout` and related components have been moved to `@kozmoai/plugin-catalog-react` and renamed. The original components are now deprecated and should be replaced as follows:
...
- 37092662cb: **BREAKING** Completely removed the `EntitySystemDiagramCard` component which was deprecated in a previous release. Any remaining references to this component are now broken and should be replaced with `EntityCatalogGraphCard`, which can be imported from package `@kozmoai/plugin-catalog-graph`.
...
- aac316279f: Deprecated `EntitySystemDiagramCard`
  `EntitySystemDiagramCard` is replaced by `EntityCatalogGraphCard` which is imported from `@kozmoai/plugin-catalog-graph`. This component will be removed in an upcoming release
- Updated dependencies
...
- 3fa31ec84a: Deprecated the `CatalogClientWrapper` class.
  ...
  The default implementation of `catalogApiRef` that this plugin exposes, is now powered by the new `fetchApiRef`. The default implementation of _that_ API, in turn, has the ability to inject the user's Glint token in requests in a similar manner to what the deprecated `CatalogClientWrapper` used to do. The latter has therefore been taken out of the default catalog API implementation.
...
- 3ed78fca3: Added the ability to switch entity kind on the catalog index page. This is a non-breaking change, but if you created a custom `CatalogPage` and wish to use this feature, make the modifications shown on [#6895](https://github.com/kozmoai/glint/pull/6895).
...
- 224e54484: Added an `EntityProcessingErrorsPanel` component to show any errors that occurred when refreshing an entity from its source location.
  ...
  If upgrading, this should be added to your `EntityPage` in your Glint application:
...
- f4e3ac5ce: Move `ScmIntegrationIcon` from `@kozmoai/plugin-catalog` to
  `@kozmoai/integration-react` and make it customizable using
  `app.getSystemIcon()`.
...
- 32a950409: Hide the kind of the owner if it's the default kind for the `ownedBy`
  relationship (group).
- f10950bd2: Minor refactoring of GlintApp.getSystemIcons to support custom registered
...
- Updated dependencies [688b73110]
  - @kozmoai/plugin-scaffolder@0.5.1
  - @kozmoai/core@0.6.2
...
- 1df75733e: Adds an `EntityLinksCard` component to display `entity.metadata.links` on entity pages. The new component is a companion for the new [Entity Links](https://glint.io/docs/features/software-catalog/descriptor-format#links-optional) catalog model addition.
...
- Updated dependencies [b51ee6ece]
  ...
  - @kozmoai/plugin-scaffolder@0.5.0
...
- 019fe39a0: `@kozmoai/plugin-catalog` stopped exporting hooks and helpers for other
  plugins. They are migrated to `@kozmoai/plugin-catalog-react`.
...
- Updated dependencies [11cb5ef94]
  - @kozmoai/plugin-scaffolder@0.4.2
  - @kozmoai/core@0.6.0
...
- Updated dependencies [9dd057662]
  - @kozmoai/plugin-scaffolder@0.4.1
...
- a08db734c: Remove the `WelcomeBanner` that links to a plugin that is not longer wired into Glint instances

## 0.2.12

### Patch Changes

- 593632f07: Derive the list of to-delete entities in the `UnregisterEntityDialog` from the `glint.io/managed-by-origin-location` annotation.
...
- Updated dependencies [a93f42213]
  ...
  - @kozmoai/core@0.5.0
  - @kozmoai/plugin-scaffolder@0.4.0
...
- 9c09a364f: Remove the unused dependency to `@kozmoai/plugin-techdocs`.
- Updated dependencies [8e083f41f]
- Updated dependencies [947d3c269]
  - @kozmoai/plugin-scaffolder@0.3.6
...
- Updated dependencies [342270e4d]
  - @kozmoai/plugin-scaffolder@0.3.5
  - @kozmoai/core@0.4.2
  - @kozmoai/plugin-techdocs@0.5.1
...
- Updated dependencies [ac3560b42]
  ...
  - @kozmoai/plugin-techdocs@0.5.0
  - @kozmoai/core@0.4.1
  - @kozmoai/catalog-client@0.3.4
  - @kozmoai/plugin-scaffolder@0.3.4
...
- Updated dependencies [ff243ce96]
  ...
  - @kozmoai/plugin-techdocs@0.4.0
  - @kozmoai/theme@0.2.2
  - @kozmoai/plugin-scaffolder@0.3.3
...
- Updated dependencies [da2ad65cb]
  ...
  - @kozmoai/plugin-scaffolder@0.3.2
  - @kozmoai/plugin-techdocs@0.3.1
...
- Updated dependencies [1185919f3]
  ...
  - @kozmoai/plugin-scaffolder@0.3.1
  - @kozmoai/catalog-client@0.3.1
  - @kozmoai/plugin-techdocs@0.2.3
...
- Updated dependencies [59166e5ec]
  - @kozmoai/core@0.3.0
  - @kozmoai/theme@0.2.1
  - @kozmoai/plugin-scaffolder@0.3.0
  - @kozmoai/plugin-techdocs@0.2.1
...
- Updated dependencies [1611c6dbc]
  - @kozmoai/plugin-scaffolder@0.2.0
  - @kozmoai/plugin-techdocs@0.2.0
  - @kozmoai/core@0.2.0
