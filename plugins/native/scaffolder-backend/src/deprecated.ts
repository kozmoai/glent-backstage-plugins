...
import { ScaffolderEntitiesProcessor as ScaffolderEntitiesProcessorModule } from '@kozmoai/plugin-catalog-backend-module-scaffolder-entity-model';

/**
 * @public
 * @deprecated Import from {@link @kozmoai/plugin-scaffolder-node#ActionContext} instead
 */
...
/**
 * @public
 * @deprecated Use `createTemplateAction` from `@kozmoai/plugin-scaffolder-node` instead
 */
export const createTemplateAction = createTemplateActionNode;

/**
 * @public
 * @deprecated Use `TaskSecrets` from `@kozmoai/plugin-scaffolder-node` instead
 */
export type TaskSecrets = TaskSecretsNode;

/**
 * @public
 * @deprecated Use `TemplateAction` from `@kozmoai/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `ExecuteShellCommandOptions` from `@kozmoai/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `executeShellCommand` from `@kozmoai/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Use `fetchContents` from `@kozmoai/plugin-scaffolder-node` instead
 */
 ...
 *
 * @public
 * @deprecated Import from `@kozmoai/plugin-catalog-backend-module-scaffolder-entity-model` instead
 */
