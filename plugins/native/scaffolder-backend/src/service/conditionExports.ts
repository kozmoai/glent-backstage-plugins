...
import { createConditionExports } from '@kozmoai/plugin-permission-node';
 ...
 * ...
 * import { createScaffolderPolicyDecision } from '@kozmoai/plugin-scaffolder-backend';
 * import { RESOURCE_TYPE_SCAFFOLDER_TEMPLATE } from '@kozmoai/plugin-scaffolder-common';
 *
