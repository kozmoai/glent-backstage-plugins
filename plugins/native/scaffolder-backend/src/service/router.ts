...
import { InputError, NotFoundError, stringifyError } from '@kozmoai/errors';
import { ScmIntegrations } from '@kozmoai/integration';
import { HumanDuration, JsonObject, JsonValue } from '@kozmoai/types';
import {
  TaskSpec,
...
} from '@kozmoai/plugin-scaffolder-common';
import {
...
} from '@kozmoai/plugin-scaffolder-common/alpha';
...
function isSupportedTemplate(entity: TemplateEntityV1beta3) {
  return entity.apiVersion === 'scaffolder.glint.io/v1beta3';
}
 ...
 * until someone explicitly passes an IdentityApi. When we have reasonable confidence that most glint deployments
