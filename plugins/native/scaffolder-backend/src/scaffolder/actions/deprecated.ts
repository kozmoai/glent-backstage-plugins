 ...
 */
import * as github from '@kozmoai/plugin-scaffolder-backend-module-github';
import * as gitlab from '@kozmoai/plugin-scaffolder-backend-module-gitlab';
import * as azure from '@kozmoai/plugin-scaffolder-backend-module-azure';
import * as bitbucket from '@kozmoai/plugin-scaffolder-backend-module-bitbucket';
import * as bitbucketCloud from '@kozmoai/plugin-scaffolder-backend-module-bitbucket-cloud';
import * as bitbucketServer from '@kozmoai/plugin-scaffolder-backend-module-bitbucket-server';
import * as gerrit from '@kozmoai/plugin-scaffolder-backend-module-gerrit';

/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-github instead
 */
...
/**
 * @public @deprecated use "createPublishBitbucketCloudAction" from \@kozmoai/plugin-scaffolder-backend-module-bitbucket-cloud or "createPublishBitbucketServerAction" from \@kozmoai/plugin-scaffolder-backend-module-bitbucket-server instead
 */
export const createPublishBitbucketAction =
  bitbucket.createPublishBitbucketAction;

/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-bitbucket-cloud instead
 */
export const createPublishBitbucketCloudAction =
  bitbucketCloud.createPublishBitbucketCloudAction;

/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-bitbucket-server instead
 */
...
/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-azure instead
 */
export const createPublishAzureAction = azure.createPublishAzureAction;

/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-gerrit instead
 */
...
/**
 * @public @deprecated use import from \@kozmoai/plugin-scaffolder-backend-module-gitlab instead
 */
