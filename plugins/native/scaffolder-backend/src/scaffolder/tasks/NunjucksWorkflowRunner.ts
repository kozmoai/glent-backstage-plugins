...
import { JsonArray, JsonObject, JsonValue } from '@kozmoai/types';
import { InputError, NotAllowedError, stringifyError } from '@kozmoai/errors';
...
import { createConditionAuthorizer } from '@kozmoai/plugin-permission-node';
...
import { actionExecutePermission } from '@kozmoai/plugin-scaffolder-common/alpha';
import { TaskRecovery } from '@kozmoai/plugin-scaffolder-common';
...
const isValidTaskSpec = (taskSpec: TaskSpec): taskSpec is TaskSpecV1beta3 => {
  return taskSpec.apiVersion === 'scaffolder.glint.io/v1beta3';
};
