...
import { JsonValue, JsonObject, HumanDuration } from '@kozmoai/types';
import { TaskSpec, TaskStep } from '@kozmoai/plugin-scaffolder-common';
import { TaskSecrets } from '@kozmoai/plugin-scaffolder-node';
import {
  TemplateAction,
 ...
 *
 * @public
 * @deprecated Import from `@kozmoai/plugin-scaffolder-node` instead.
 */
