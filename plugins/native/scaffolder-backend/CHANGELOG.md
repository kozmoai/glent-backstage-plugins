# @kozmoai/plugin-scaffolder-backend
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend-module-scaffolder-entity-model@0.1.7-next.2
...
- 8872cc735d: Fixed a bug in plugin-scaffolder-backend where it ignores the skip migration database options.
  ...
  import { DatabaseTaskStore } from '@kozmoai/plugin-scaffolder-backend';
...
- 0d8d650e32: Applied the fix from version 1.5.1 of this package, which is part of the v1.5.1 release of Glint.
...
- 2f3d3a1eae: build(deps): bump `@gitbeaker/core` from 34.6.0 to 35.6.0
- Updated dependencies
  - @kozmoai/plugin-catalog-backend@1.1.0-next.2
...
- f9c7bdd899: **BREAKING**:
  ...
  - Removed the `createFetchCookiecutterAction` export, please use the `@kozmoai/plugin-scaffolder-backend-module-cookiecutter` package explicitly (see [its README](https://github.com/kozmoai/glint/tree/master/plugins/scaffolder-backend-module-cookiecutter) for installation instructions).
...
- 5c7f2343ea: Applied fix from version 0.17.2 of this package, which is part of the v0.69.2 release of Glint.
...
- c7f6424a26: Applied fix from `v0.17.1` of this package which is part of the `v0.69.1` release of Glint.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.2.3
...
- 9d9b2bab47: - **BREAKING** - Removed the re-export of types `TaskSpec` `TaskSpecV1Beta2` and `TaskSpecV1Beta3` these should now be import from `@kozmoai/plugin-scaffolder-common` directly.
  - **BREAKING** - Removed the `observe` method from the `TaskBroker` interface, this has now been replaced with an `Observable` implementation under `event# @kozmoai/plugin-scaffolder-backend.
...
- 6981ac4ad2: - **DEPRECATED** - The `containerRunner` option passed to `createBuiltinActions` has now been deprecated.
  ...
  The `fetch:cookiecutter` action will soon be removed from the default list of actions that are provided out of the box from the scaffolder plugin. It will still be supported, and maintained by the community, so you can install the package (`@kozmoai/plugin-scaffolder-backend-module-cookiecutter`) and pass it in as a custom action. Or you can migrate your templates to use [`fetch:template`](https://glint.io/docs/features/software-templates/builtin-actions#migrating-from-fetchcookiecutter-to-fetchtemplate) with the `cookiecutterCompat` option.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.2.2
...
- Updated dependencies
  ...
  - @kozmoai/types@0.1.3
  - @kozmoai/plugin-catalog-backend@0.21.5
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.2.1
...
- 8db2b671c6: **BREAKING**: `ctx.token` is now `ctx.secrets.glintToken` in Actions. Please update any of your Actions that might call out to Glint API's with this token.
...
- 7d3471db94: Remove the previously deprecated `scaffolder.provider` config for all providers.
  This config is no longer used anywhere, and adopters should use [`integrations` config](https://glint.io/docs/integrations) instead.
...
- Updated dependencies
  ...
  - @kozmoai/types@0.1.2
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.2.0
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.11
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.11-next.0
...
- c95df1631e: Added support for templating secrets into actions input, and also added an extra `token` input argument to all publishers to provide a token that would override the `integrations.config`.
  You can find more information over at [Writing Templates](https://glint.io/docs/features/software-templates/writing-templates#using-the-users-oauth-token)
- Updated dependencies
  - @kozmoai/plugin-catalog-backend@0.21.2
  - @kozmoai/backend-common@0.10.6
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.10
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.21.2-next.1
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.0
...
- ac2f1eeec0: This change is for adding the option of inputs on the `github:actions:dispatch` Glint Action. This will allow users to pass data from Glint to the GitHub Action.
- 0d5e846a78: Expose a new option to provide additional template filters via `@kozmoai/scaffolder-backend`'s `createRouter()` function.
- Updated dependencies
  - @kozmoai/plugin-catalog-backend@0.21.1
...
- b05d303226: Added the ability to support supplying secrets when creating tasks in the `scaffolder-backend`.
  ...
  **deprecation**: Deprecated `ctx.token` from actions in the `scaffolder-backend`. Please move to using `ctx.secrets.glintToken` instead.

  **deprecation**: Deprecated `task.token` in `TaskSpec` in the `scaffolder-backend`. Please move to using `task.secrets.glintToken` instead.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.9
  - @kozmoai/plugin-scaffolder-common@0.1.3
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.9-next.0
  - @kozmoai/plugin-scaffolder-common@0.1.3-next.0
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.8
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.19.4
  - @kozmoai/plugin-scaffolder-common@0.1.2
  - @kozmoai/integration@0.7.0
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.7
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.19.3
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.6
...
- Updated dependencies
  - @kozmoai/plugin-catalog-backend@0.19.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.19.1
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.5
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.17.4
...
- b45a34fb15: Adds a new endpoint for consuming logs from the Scaffolder that uses long polling instead of Server Sent Events.
  ...
  This is useful if Glint is accessed from an environment that doesn't support SSE correctly, which happens in combination with certain enterprise HTTP Proxy servers.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-catalog-backend@0.17.3
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.4
...
- 41c49884d2: Start using the new `@kozmoai/types` package. Initially, this means using the `Observable` and `Json*` types from there. The types also remain in their old places but deprecated, and will be removed in a future release.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.3
  - @kozmoai/plugin-scaffolder-common@0.1.1
...
- 18083d1821: Introduce the new `scaffolder.glint.io/v1beta3` template kind with nunjucks support 🥋
- Updated dependencies
...
- 618143c3c7: Action needed: If you are using the templates located at https://github.com/kozmoai/glint/tree/master/ in your Glint app directly using the URL via the `app-config.yaml`, you should copy over the templates inside your org and import from there. The templates have now been moved to https://github.com/kozmoai/software-templates. See https://github.com/kozmoai/glint/issues/6415 for explanation.
...
- 3f9dd1759: GitHub create repository webhook action: `github:webhook` for Glint plugin Scaffolder has been added.
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-scaffolder-backend-module-cookiecutter@0.1.1
...
- eb740ee24: Moved sample software templates to the [glint/software-templates](https://github.com/kozmoai/software-templates) repository. If you previously referenced the sample templates straight from `scaffolder-backend` plugin in the main [kozmoai/glint](https://github.com/kozmoai/glint) repository in your `app-config.yaml`, these references will need to be updated.

  See https://github.com/kozmoai/software-templates
...
- 31de5f27f: Add new `fetch:template` action which handles the same responsibilities as `fetch:cookiecutter` without the external dependency on `cookiecutter`. For information on migrating from `fetch:cookiecutter` to `fetch:template`, see the [migration guide](https://glint.io/docs/features/software-templates/builtin-actions#migrating-from-fetch-cookiecutter-to-fetch-template) in the docs.
...
- 55a253de2: Migrating old `glint.io/v1alpha1` templates to `glint.io/v1beta2`
  ...
  ```diff
  -    - type: url
  -      target: https://github.com/kozmoai/glint/blob/master/plugins/scaffolder-backend/sample-templates/create-react-app/template.yaml
  -      rules:
  -        - allow: [Template]
  ```
...
- e0bfd3d44: Migrate the plugin to use the `ContainerRunner` interface instead of `runDockerContainer(…)`.
  ...
  ```diff
  - import { SingleHostDiscovery } from '@kozmoai/backend-common';
  + import {
  +   DockerContainerRunner,
  +   SingleHostDiscovery,
  + } from '@kozmoai/backend-common';
...
- d7245b733: Remove runDockerContainer, and start using the utility function provided by @kozmoai/backend-common
...
- a5f42cf66: # Stateless scaffolding
  ...
  As well as adding the `@kozmoai/catalog-client` packages as a dependency of your backend package.
...
- ffffea8e6: Minor updates to reflect the changes in `@kozmoai/integration` that made the fields `apiBaseUrl` and `apiUrl` mandatory.
...
- 26a3a6cf0: Honor the branch ref in the url when cloning.
  ...
  catalog:
    locations:
      - type: url
        target: https://github.com/kozmoai/glint/blob/other/plugins/scaffolder-backend/sample-templates/docs-template/template.yaml
  ```
...
- ed6baab66: - Deprecating the `scaffolder.${provider}.token` auth duplication and favoring `integrations.${provider}` instead. If you receive deprecation warnings your config should change like the following:
  ...
  `glint/new-repository` would become `https://github.com/kozmoai/new-repository` if provider was GitHub for example.
...
- 59166e5ec: `createRouter` of scaffolder backend will now require additional option as `entityClient` which could be generated by `CatalogEntityClient` in `plugin-scaffolder-backend` package. Here is example to generate `entityClient`.
  ...
  ```js
  import { CatalogEntityClient } from '@kozmoai/plugin-scaffolder-backend';
  import { SingleHostDiscovery } from '@kozmoai/backend-common';
