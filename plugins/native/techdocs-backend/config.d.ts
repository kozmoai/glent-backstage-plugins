...
export interface Config {
   ...
   * @see http://glint.io/docs/features/techdocs/configuration
   */
  techdocs: {
    /**
    ...
    publisher?:
      ...
      | {
          ...
          awsS3?: {
             ...
             * See the
             * [integration-aws-node package](https://github.com/kozmoai/glint/blob/master/packages/integration-aws-node/README.md)
