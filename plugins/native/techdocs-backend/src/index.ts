...
/**
 * The Glint backend plugin that renders technical documentation for your components
 *
...
} from '@kozmoai/plugin-techdocs-node';
...
/**
 * @public
 * @deprecated import from `@kozmoai/plugin-techdocs-node` instead
 */
