...
import { pageTheme } from '@kozmoai/theme';
import { v4 as uuid } from 'uuid';
import { ShortcutApi, type Shortcut } from '@kozmoai/plugin-shortcuts';
import type { StorageApi } from '@kozmoai/core-plugin-api';
import type { Observable } from '@kozmoai/types';
import ObservableImpl from 'zen-observable';

/**
 * Default implementation of the {@link ShortcutApi} that uses the
 * {@link @kozmoai/core-plugin-api#StorageApi} to store shortcuts.
 *
 * @remarks
 *
