...
import { NotFoundError, NotModifiedError } from '@kozmoai/errors';
...
describe('TodoScmReader', () => {
  ...
  it('should read TODOs', async () => {
    ...
    const url = 'https://github.com/kozmoai/glint/catalog-info.yaml';
    const expected = {
      items: [
        {
          text: 'my-todo',
          ...
          viewUrl:
            'https://github.com/kozmoai/glint/my-folder/my-file.js#L1',
        },
      ],
    };
  ...
  it('should use custom parser', async () => {
    ...
    await expect(
      todoReader.readTodos({
        url: 'https://github.com/kozmoai/glint/catalog-info.yaml',
      }),
    ).resolves.toEqual({
      items: [
        {
          ...
          viewUrl: 'https://github.com/kozmoai/glint/my-file.lua#L1',
        },
      ],
    });
