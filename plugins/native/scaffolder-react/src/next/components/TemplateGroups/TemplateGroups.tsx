...
import { useEntityList } from '@kozmoai/plugin-catalog-react';
import {
  isTemplateEntityV1beta3,
  TemplateEntityV1beta3,
} from '@kozmoai/plugin-scaffolder-common';
import { Progress, Link } from '@kozmoai/core-components';
import { Typography } from '@material-ui/core';
import { errorApiRef, IconComponent, useApi } from '@kozmoai/core-plugin-api';
  ...
  if (!entities || !entities.length) {
    return (
      <Typography variant="body2">
        ...
        <Link to="https://glint.io/docs/features/software-templates/adding-templates">
          adding templates
        </Link>
        .
      </Typography>
