...
- 831a8fee86: Send Authorization headers in fetch requests using FetchApi in Code Climate plugin to fix unauthorized requests to Glint backends with authentication enabled.
- Updated dependencies
