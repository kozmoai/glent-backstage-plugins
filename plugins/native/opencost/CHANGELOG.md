...
- 1380a689ab56: New OpenCost plugin provides an port of the latest OpenCost UI to Glint with updated dependencies. The plugin's README covers installation and configuration
