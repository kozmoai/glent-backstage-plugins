...
import { isError } from '@kozmoai/errors';
import {
  CatalogProcessor,
 ...
 *
 * @public
 * @deprecated Use the `AwsS3EntityProvider` instead (see https://github.com/kozmoai/glint/blob/master/plugins/catalog-backend-module-aws/CHANGELOG.md#014).
 */
