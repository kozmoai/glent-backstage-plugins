...
import { NotImplementedError } from '@kozmoai/errors';
 ...
 * integration between the permission backend and other Glint backend
 ...
 * @remarks
 *
 * To make this concrete, we can use the Glint software catalog as an
 ...
 * {@link @kozmoai/catalog-model#EntityRef}. For other plugins, this can be
...
>(
  ...
  router.get('/.well-known/glint/permissions/metadata', (_, res) => {
  ...
  router.post(
    '/.well-known/glint/permissions/apply-conditions',
