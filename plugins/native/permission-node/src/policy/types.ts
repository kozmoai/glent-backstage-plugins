...
/**
 * A policy to evaluate authorization requests for any permissioned action performed in Glint.
 *
 * @remarks
 *
 * This takes as input a permission and an optional Glint identity, and should return ALLOW if
