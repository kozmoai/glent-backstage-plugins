# @kozmoai/plugin-microsoft-calendar
...
- 44412375bb: Created a new plugin `@kozmoai/plugin-microsoft-calendar` to display events from a Microsoft Calendar.

  please refer to the [README.md](https://github.com/kozmoai/glint/blob/master/plugins/microsoft-calendar/README.md) for step-by-step instructions to setup the plugin in your Glint instance.
