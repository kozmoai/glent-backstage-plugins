...
Backend plugin for serving badges to the `@kozmoai/plugin-badges` plugin.
...
Install the `@kozmoai/plugin-badges-backend` package in your backend package:

```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-badges-backend
```
...
} from '@kozmoai/plugin-badges-backend';
...
The Badges backend plugin has support for the [new backend system](https://glint.io/docs/backend-system/), here's how you can set that up:
...
+ backend.add(import('@kozmoai/plugin-badges-backend'));
...
[badges.ts](https://github.com/kozmoai/glint/tree/master/plugins/badges-backend/src/badges.ts)
as examples.
...
```ts
import type { Badge, BadgeContext, BadgeFactories } from '@kozmoai/plugin-badges-backend';
...
- `/badges/entity/:namespace/:kind/:name/badge-specs` List all defined badges
  ...
  [BadgeSpec](https://github.com/kozmoai/glint/tree/master/plugins/badges/src/api/types.ts)
...
- [Frontend part of the plugin](https://github.com/kozmoai/glint/tree/master/plugins/badges)
