...
This plugin provides an opinionated implementation of the Glint Analytics
API for Google Analytics 4. Once installed and configured, analytics events will
be sent to GA as your users navigate and use your Glint instance.

This plugin contains no other functionality.

## Installation

1. Install the plugin package in your Glint app:

```sh
# From your Glint root directory
yarn --cwd packages/app add @kozmoai/plugin-analytics-module-ga4
```
...
import { GoogleAnalytics4 } from '@kozmoai/plugin-analytics-module-ga4';
...
In order to be able to analyze usage of your Glint instance by plugin, we recommend configuring [a content grouping](#enabling-content-grouping).
...
1. Be sure you've gone through the process of setting up a user ID view in your
   Glint instance's Google Analytics property (see docs linked above).
...
import { GoogleAnalytics } from '@kozmoai/plugin-analytics-module-ga';
...
normally `gitignore`'d but loaded and merged in when Glint is bootstrapped.
...
1. Clone the main Glint monorepo `git clone git@github.com:kozmoai/glint.git`
