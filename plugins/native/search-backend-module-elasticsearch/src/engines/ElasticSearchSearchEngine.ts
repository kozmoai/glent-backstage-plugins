...
import { MissingIndexError } from '@kozmoai/plugin-search-backend-node';
...
export class ElasticSearchSearchEngine implements SearchEngine {
   ...
   *
   * ```ts
   * import { isOpenSearchCompatible } from '@kozmoai/plugin-search-backend-module-elasticsearch';
  ...
  async getIndexer(type: string) {
    ...
    // todo(@kozmoai/discoverability-maintainers): Consider introducing a more
