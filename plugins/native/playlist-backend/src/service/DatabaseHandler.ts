...
import { resolvePackagePath } from '@kozmoai/backend-common';
import { GlintUserPrincipal } from '@kozmoai/backend-plugin-api';
import { Playlist, PlaylistMetadata } from '@kozmoai/plugin-playlist-common';
...
const migrationsDir = resolvePackagePath(
  '@kozmoai/plugin-playlist-backend',
  'migrations',
);
...
export class DatabaseHandler {
  ...
  async followPlaylist(playlistId: string, user: GlintUserPrincipal) {
    await this.database('followers')
  ...
  async unfollowPlaylist(playlistId: string, user: GlintUserPrincipal) {
    await this.database('followers')
