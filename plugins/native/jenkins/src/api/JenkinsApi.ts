...
import type { CompoundEntityRef } from '@kozmoai/catalog-model';
...
export interface JenkinsApi {
   ...
   *
   * Deciding what jobs are for an entity can be configured by the glint _Integrator_ in the plugin-jenkins-backend setup
