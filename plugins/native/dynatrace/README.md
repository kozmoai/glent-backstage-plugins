...
This plugin uses the Glint proxy to communicate with Dynatrace's REST APIs.
...
yarn --cwd packages/app add @kozmoai/plugin-dynatrace
```
...
[...]
+ import { DynatraceTab, isDynatraceAvailable } from '@kozmoai/plugin-dynatrace'
