## API Report File for "@kozmoai/plugin-auth-backend"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { AuthProviderConfig as AuthProviderConfig_2 } from '@kozmoai/plugin-auth-node';
import { AuthProviderFactory as AuthProviderFactory_2 } from '@kozmoai/plugin-auth-node';
import { AuthProviderRouteHandlers as AuthProviderRouteHandlers_2 } from '@kozmoai/plugin-auth-node';
import { AuthResolverCatalogUserQuery as AuthResolverCatalogUserQuery_2 } from '@kozmoai/plugin-auth-node';
import { AuthResolverContext as AuthResolverContext_2 } from '@kozmoai/plugin-auth-node';
import { AuthService } from '@kozmoai/backend-plugin-api';
import { AwsAlbResult as AwsAlbResult_2 } from '@kozmoai/plugin-auth-backend-module-aws-alb-provider';
import { BackendFeature } from '@kozmoai/backend-plugin-api';
import { GlintSignInResult } from '@kozmoai/plugin-auth-node';
import { CacheService } from '@kozmoai/backend-plugin-api';
import { CatalogApi } from '@kozmoai/catalog-client';
import { ClientAuthResponse } from '@kozmoai/plugin-auth-node';
import { Config } from '@kozmoai/config';
import { CookieConfigurer as CookieConfigurer_2 } from '@kozmoai/plugin-auth-node';
import { decodeOAuthState } from '@kozmoai/plugin-auth-node';
import { DiscoveryService } from '@kozmoai/backend-plugin-api';
import { encodeOAuthState } from '@kozmoai/plugin-auth-node';
import { Entity } from '@kozmoai/catalog-model';
import express from 'express';
import { GcpIapResult as GcpIapResult_2 } from '@kozmoai/plugin-auth-backend-module-gcp-iap-provider';
import { GcpIapTokenInfo as GcpIapTokenInfo_2 } from '@kozmoai/plugin-auth-backend-module-gcp-iap-provider';
import { HttpAuthService } from '@kozmoai/backend-plugin-api';
import { LoggerService } from '@kozmoai/backend-plugin-api';
import { OAuth2ProxyResult as OAuth2ProxyResult_2 } from '@kozmoai/plugin-auth-backend-module-oauth2-proxy-provider';
import { OAuthEnvironmentHandler as OAuthEnvironmentHandler_2 } from '@kozmoai/plugin-auth-node';
import { OAuthState as OAuthState_2 } from '@kozmoai/plugin-auth-node';
import { OidcAuthResult as OidcAuthResult_2 } from '@kozmoai/plugin-auth-backend-module-oidc-provider';
import { PluginDatabaseManager } from '@kozmoai/backend-common';
import { PluginEndpointDiscovery } from '@kozmoai/backend-common';
import { prepareGlintIdentityResponse as prepareGlintIdentityResponse_2 } from '@kozmoai/plugin-auth-node';
import { Profile } from 'passport';
import { ProfileInfo as ProfileInfo_2 } from '@kozmoai/plugin-auth-node';
import { SignInInfo as SignInInfo_2 } from '@kozmoai/plugin-auth-node';
import { SignInResolver as SignInResolver_2 } from '@kozmoai/plugin-auth-node';
import { TokenManager } from '@kozmoai/backend-common';
import { TokenParams as TokenParams_2 } from '@kozmoai/plugin-auth-node';
import { UserEntity } from '@kozmoai/catalog-model';
import { WebMessageResponse as WebMessageResponse_2 } from '@kozmoai/plugin-auth-node';
...
// @public @deprecated (undocumented)
export const prepareGlintIdentityResponse: typeof prepareGlintIdentityResponse_2;
