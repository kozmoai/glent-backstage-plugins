...
import { RootConfigService } from '@kozmoai/backend-plugin-api';
import { readDurationFromConfig } from '@kozmoai/config';
...
export function readGlintTokenExpiration(config: RootConfigService) {
  const processingIntervalKey = 'auth.glintTokenExpiration';
