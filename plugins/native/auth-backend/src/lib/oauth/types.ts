...
/**
 * @public
 * @deprecated Use `OAuthAuthenticatorResult<PassportProfile>` from `@kozmoai/plugin-auth-node` instead
 */
...
/**
 * @public
 * @deprecated Use `ClientAuthResponse` from `@kozmoai/plugin-auth-node` instead
 */
export type OAuthResponse = {
  profile: ProfileInfo;
  providerInfo: OAuthProviderInfo;
  glintIdentity?: GlintSignInResult;
};
...
/**
 * @public
 * @deprecated import from `@kozmoai/plugin-auth-node` instead
 */
