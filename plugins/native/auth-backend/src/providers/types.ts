...
/**
 * @public
 * @deprecated Use `createOAuthAuthenticator` from `@kozmoai/plugin-auth-node` instead
 */
...
/**
 * @public
 * @deprecated import `ClientAuthResponse` from `@kozmoai/plugin-auth-node` instead
 */
