...
It also provides the ability to trigger new incidents to specific users and/or specific teams from within Glint.
...
yarn --cwd packages/app add @kozmoai/plugin-splunk-on-call
```
...
} from '@kozmoai/plugin-splunk-on-call';
// ...
