...
- 02faa6781b: The Splunk On-Call plugin now supports an optional `readOnly` property (`<SplunkOnCallEntityCard readOnly />`) for suppressing the rendering of incident trigger-acknowledge-resolve controls from the Glint UI.
- Updated dependencies
...
- 8aa0b6025: Updates the Splunk On-Call plugin for the [composability system
  migration](https://glint.io/docs/plugins/composability#porting-existing-plugins).
