 ...
 * @public
 */
export const LDAP_RDN_ANNOTATION = 'glint.io/ldap-rdn';
 ...
 * @public
 */
export const LDAP_DN_ANNOTATION = 'glint.io/ldap-dn';
 ...
 * @public
 */
export const LDAP_UUID_ANNOTATION = 'glint.io/ldap-uuid';
