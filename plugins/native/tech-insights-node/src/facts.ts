...
import { HumanDuration, JsonValue } from '@kozmoai/types';
import {
 ...
 * Each container contains a reference to an entity which can be a Glint entity or a generic construct
 * outside of glint with same shape.
 *
