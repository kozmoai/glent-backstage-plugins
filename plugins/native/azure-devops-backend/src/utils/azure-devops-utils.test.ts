  ...
  it('should return DashboardPullRequest', () => {
    ...
    const pullRequest: GitPullRequest = {
      ...
      repository: {
        id: 'repo1',
        name: 'azure-devops',
        url: 'https://dev.azure.com/kozmoai/glint/_apis/git/repositories/azure-devops',
        project: {
          name: 'glint',
        },
      },
    ...
    const expectedPullRequest: DashboardPullRequest = {
      ...
      repository: {
        id: 'repo1',
        name: 'azure-devops',
        url: 'https://dev.azure.com/kozmoai/glint/_git/azure-devops',
      },
      createdBy: {
        id: 'user1',
        displayName: 'User 1',
      ...
      status: PullRequestStatus.Active,
      isDraft: false,
      link: 'https://dev.azure.com/glint/_git/azure-devops/pullrequest/1',
    };
...
describe('getPullRequestLink', () => {
  it('should return pull request link', () => {
    ...
    expect(result).toBe(`${baseUrl}/glint/_git/azure-devops/pullrequest/1`);
  });
});
