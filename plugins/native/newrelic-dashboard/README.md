...
This plugin uses the Glint proxy to securely communicate with New Relic's APIs. We use NerdGraph (New Relic's GraphQL API)
...
} from '@kozmoai/plugin-newrelic-dashboard';
