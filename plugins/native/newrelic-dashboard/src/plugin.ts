...
/**
 * Render dashboard snapshots from Newrelic in glint. Use dashboards which have the tag `isDashboardPage: true`
 *
 * @remarks
...
/**
 * Render a dashboard snapshots list from Newrelic in glint. Use dashboards which have the tag `isDashboardPage: true`
 *
 * @remarks
 * This can be helpful for rendering dashboards outside of Entity Catalog.
 *
