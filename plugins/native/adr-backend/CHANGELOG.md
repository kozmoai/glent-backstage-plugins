...
- a8805a9a4f25: Added support for the [new backend system](https://glint.io/docs/backend-system/)
- Updated dependencies
  - @kozmoai/errors@1.2.1
...
- aa17643a06: This plugin now exports a `createRouter` method which uses `UrlReaders` to make requests to your SCM. Please make sure you read the [install instructions](https://github.com/kozmoai/glint/blob/master/plugins/adr-backend/README.md#install)
...
- Updated dependencies
  ...
  - @kozmoai/backend-common@0.15.0-next.2
...
- Updated dependencies
  ...
  - @kozmoai/plugin-adr-common@0.1.0-next.1
