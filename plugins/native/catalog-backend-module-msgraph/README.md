    ...
    microsoftGraphOrg:
      providerId:
        ...
        userGroupMember:
          ...
          filter: "displayName eq 'Glint Users'"
...
3. The package is not installed by default, therefore you have to add a
   dependency to `@kozmoai/plugin-catalog-backend-module-msgraph` to your
   backend package.

```bash
# From your Glint root directory
yarn --cwd packages/backend add @kozmoai/plugin-catalog-backend-module-msgraph
```
...
+import { MicrosoftGraphOrgEntityProvider } from '@kozmoai/plugin-catalog-backend-module-msgraph';
