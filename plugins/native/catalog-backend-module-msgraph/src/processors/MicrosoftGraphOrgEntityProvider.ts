...
import { PluginTaskScheduler, TaskRunner } from '@kozmoai/backend-tasks';
import {
  ANNOTATION_LOCATION,
...
export class MicrosoftGraphOrgEntityProvider implements EntityProvider {
  ...
  private static fromLegacyConfig(
    ...
    options.logger.warn(
      'Deprecated msgraph config "catalog.processors.microsoftGraphOrg" used. Use "catalog.providers.microsoftGraphOrg" instead. More info at https://github.com/kozmoai/glint/blob/master/plugins/catalog-backend-module-msgraph/CHANGELOG.md#040-next1',
    );
