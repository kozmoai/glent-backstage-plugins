...
jest.mock('@kozmoai/core-plugin-api', () => ({
  ...jest.requireActual('@kozmoai/core-plugin-api'),
    ...
    expect(result.current).toMatchInlineSnapshot(`
      {
        ...
        "responseSteps": [
          ...
          {
            "message": <PatchDryRunMessage
              message="Created temporary patch dry run branch "rc/2020.01.01_1-glint-grm-patch-dry-run""
            />,
          },
          {
            "message": <PatchDryRunMessage
          ...
          {
            "message": <PatchDryRunMessage
              message="Forced branch "rc/2020.01.01_1-glint-grm-patch-dry-run" to temporary commit "mock_commit_sha""
            />,
          },
          {
            "message": <PatchDryRunMessage
              message="Merged temporary commit into "rc/2020.01.01_1-glint-grm-patch-dry-run""
            />,
          },
          {
            "message": <PatchDryRunMessage
          ...
          {
            "message": <PatchDryRunMessage
              message="Deleted temporary patch prep branch "rc/2020.01.01_1-glint-grm-patch-dry-run""
            />,
          },
          {
