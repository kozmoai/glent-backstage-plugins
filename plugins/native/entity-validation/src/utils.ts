 ...
 */
import { Entity, stringifyLocationRef } from '@kozmoai/catalog-model';
...
// Copy from: https://github.com/kozmoai/glint/blob/master/plugins/catalog-backend/src/modules/util/parse.ts
