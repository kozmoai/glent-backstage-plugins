...
import { GlintUserIdentity } from '@kozmoai/core-plugin-api';
...
// @public (undocumented)
const userSettingsPlugin: GlintPlugin<
  {
...
export const useUserProfile: () =>
  | {
      ...
      displayName: string;
      loading: boolean;
      glintIdentity?: undefined;
    }
  | {
      profile: ProfileInfo;
      glintIdentity: GlintUserIdentity;
      displayName: string;
      loading: false;
    };
```
