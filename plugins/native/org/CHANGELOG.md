...
- 228ab677d31: Added `entityLimit` to change the limit of entities displayed in the ownership boxes.
  ...
  [StoryBook Example for Ownership Card](https://glint.io/storybook/?path=/story/plugins-org-ownership-card--default)
...
- ab6650ede9: Added an edit button to the `UserProfileCard` that is enabled when the `glint.io/edit-url` is present, this matches how the `GroupProfileCard` works
...
- 8ef71ed32: Add a `<Avatar>` component to `@kozmoai/core`.
