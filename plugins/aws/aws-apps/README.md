...
-->
# GLINT on AWS Frontend

This is the frontend UI of the GLINT on AWS plugin.  An AWS Catalog Page and several entity cards are contributed to the UI from this plugin.
...
Install the GLINT on AWS frontend plugin into your Backstage application:
...
Each of the UI components contributed in the GLINT on AWS frontend plugin can be configured independently and added to your Backstage platform as desired.  Details for adding each type of UI component are found in the sections below.
